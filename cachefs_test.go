...
// testMetrics implements cfsread.Metrics for use in unit tests. It uses
// sync/atomic counters so it is safe to use from multiple goroutines.
// Only hits, misses, and bypasses are tracked; all observation methods are no-ops.
