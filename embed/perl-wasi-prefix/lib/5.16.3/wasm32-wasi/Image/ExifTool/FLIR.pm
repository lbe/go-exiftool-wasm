...
%Image::ExifTool::FLIR::Main = (
    ...
    0x01 => { Name => 'ImageTemperatureMax',
        %temperatureInfo,
        Notes => q{
            these temperatures may be in Celsius, Kelvin or Fahrenheit, but there is no
            way to tell which
        }, },
    0x02 => { Name => 'ImageTemperatureMin', %temperatureInfo }, 0x03 =>
      { Name => 'Emissivity',
        Writable     => 'rational64u',
...
%Image::ExifTool::FLIR::FFF = (
    ...
    0x20 => {
        Name => 'CameraInfo', SubDirectory =>
          { TagTable => 'Image::ExifTool::FLIR::CameraInfo' },
    },
    0x21 => { Name => 'MeasurementInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::FLIR::MeasInfo' }, },
    0x22 => {
        Name => 'PaletteInfo', SubDirectory =>
          { TagTable => 'Image::ExifTool::FLIR::PaletteInfo' },
    },
    0x23 => {
        Name         => 'TextInfo',
...
%Image::ExifTool::FLIR::CameraInfo = (
    ...
    0x3c => {
        ...
        Format    => 'float',
        ValueConv => '$val > 2 ? $val / 100 : $val', PrintConv =>
          'sprintf("%.1f %%",$val*100)',
    },
    0x58 => { Name => 'PlanckR1', %float8g }, 0x5c =>
      { Name => 'PlanckB', %float8g }, 0x60 => { Name => 'PlanckF', %float8g }
    ,  0x070 => { Name => 'AtmosphericTransAlpha1', %float6f }, 0x074 =>
      { Name => 'AtmosphericTransAlpha2', %float6f }, 0x078 =>
      { Name => 'AtmosphericTransBeta1',  %float6f }, 0x07c =>
      { Name => 'AtmosphericTransBeta2',  %float6f }, 0x080 =>
      { Name => 'AtmosphericTransX',      %float6f },   0x90 =>
      { Name => 'CameraTemperatureRangeMax', %floatKelvin },
    0x94 => { Name => 'CameraTemperatureRangeMin', %floatKelvin },
    0x98 => { Name => 'CameraTemperatureMaxClip',  %floatKelvin }, 0x9c =>
      { Name => 'CameraTemperatureMinClip',      %floatKelvin }, 0xa0 =>
      { Name => 'CameraTemperatureMaxWarn',      %floatKelvin }, 0xa4 =>
      { Name => 'CameraTemperatureMinWarn',      %floatKelvin }, 0xa8 =>
      { Name => 'CameraTemperatureMaxSaturated', %floatKelvin }, 0xac =>
      { Name => 'CameraTemperatureMinSaturated', %floatKelvin }, 0xd4 =>
      { Name => 'CameraModel', Format => 'string[32]' },
    0xf4 => { Name => 'CameraPartNumber', Format => 'string[16]' }, 0x104 =>
      { Name => 'CameraSerialNumber', Format => 'string[16]' }, 0x114 =>
      { Name => 'CameraSoftware',     Format => 'string[16]' }, 0x170 =>
      { Name => 'LensModel',          Format => 'string[32]' },
    ...
    0x308 => { Name => 'PlanckO',            Format => 'int32s' }, 0x30c =>
      { Name => 'PlanckR2', %float8g }, 0x310 => {
...
%Image::ExifTool::FLIR::MeasInfo = (
    ...
    Meas1Type => {
        PrintConv => {
            ...
            3 => 'Ellipse',
            4 => 'Line',
            5 => 'Endpoint', 6 => 'Alarm', 7 => 'Unused', 8 => 'Difference',
        },
    },
    Meas1Params => {
        Notes =>
...
%Image::ExifTool::FLIR::PaletteInfo = (
    ...
    PROCESS_PROC => \&Image::ExifTool::ProcessBinaryData,
    FIRST_ENTRY  => 0,
    0x00         => { Name => 'PaletteColors',
        RawConv => '$$self{PaletteColors} = $val', },
    0x06 => {
        Name   => 'AboveColor',
        Format => 'int8u[3]',
        Notes  => 'Y Cr Cb color components'
      }, 0x09 => { Name => 'BelowColor', Format => 'int8u[3]' }, 0x0c =>
      { Name => 'OverflowColor',  Format => 'int8u[3]' }, 0x0f =>
      { Name => 'UnderflowColor', Format => 'int8u[3]' }, 0x12 =>
      { Name => 'Isotherm1Color', Format => 'int8u[3]' }, 0x15 =>
      { Name => 'Isotherm2Color', Format => 'int8u[3]' }, 0x1a =>
      { Name => 'PaletteMethod' }, 0x1b => { Name => 'PaletteStretch' }
    , 0x30 => {
...
%Image::ExifTool::FLIR::GPSInfo = (
    ...
    0x10 => {
        Name      => 'GPSLatitude',
        Condition => '$$self{GPSValid}', Format => 'double', PrintConv =>
    ...
    0x20 => {
        Name      => 'GPSAltitude',
        Condition => '$$self{GPSValid}', Format => 'float',
        PrintConv => 'sprintf("%.2f m", $val)',
    },
    0x40 => {
        Name        => 'GPSDOP',
        ...
        Format      => 'float',
        RawConv     => '$val > 0 ? $val : undef', PrintConv =>
          'sprintf("%.2f", $val)',
    },
    0x44 => {
        Name      => 'GPSSpeedRef',
...
%Image::ExifTool::FLIR::MoreInfo = (
    ...
    11 => { Name => 'UnknownTemperature1', %floatKelvin, Unknown => 1 }, 15 =>
      { Name => 'UnknownTemperature2', %floatKelvin, Unknown => 1 }, );
