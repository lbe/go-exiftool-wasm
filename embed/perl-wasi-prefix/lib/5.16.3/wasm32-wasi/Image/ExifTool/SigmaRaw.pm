...
%Image::ExifTool::SigmaRaw::Properties = (
    ...
    AFAREA => 'AFArea', AFINFOCUS => 'AFInFocus', AFMODE => 'FocusMode',
    ...
    CM_DESC   => 'SceneCaptureType', COLORSPACE => 'ColorSpace', DRIVE => {
        Name      => 'DriveMode',
        PrintConv => {
            SINGLE => 'Single Shot',
            MULTI  => 'Multi Shot',
    ...
    FLASHTTLMODE => 'FlashTTLMode', FLASHTYPE => 'FlashType', FLENGTH => {
        Name      => 'FocalLength',
    ...
    IMAGEBOARDID => 'ImageBoardID', ISO => 'ISO',
