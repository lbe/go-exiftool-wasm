...
%Image::ExifTool::Parrot::V1 = (
    ...
    14 => {
        Name => 'FrameView', Format => 'int16s[4]',
    ...
    36.1 => {
        Name => 'GPSSatellites', Format => 'int32s',
        Mask => 0xff,
    },
    40 => {
...
%Image::ExifTool::Parrot::V2 = (
    ...
    20 => {
        Name      => 'GPSVelocityNorth', Format => 'int16s',
        ValueConv => '$val / 0x100',
    },
    22 => {
        Name      => 'GPSVelocityEast', Format => 'int16s',
        ValueConv => '$val / 0x100',
    },
    24 => {
        Name      => 'GPSVelocityDown', Format => 'int16s',
        ValueConv => '$val / 0x100',
    },
    26 => {
        Name      => 'AirSpeed', Format => 'int16s',
        RawConv   => '$val < 0 ? undef : $val',
        ValueConv => '$val / 0x100',
    },
    28 => {
        Name => 'DroneQuaternion', Format => 'int16s[4]',
    ...
    53.1 => {
        ...
        PrintConv => {
            ...
            1 => 'Return Home',
            2 => 'Flight Plan',
            3 => 'Follow Me / Tracking', 4 => 'Magic Carpet',
            5 => 'Move To',
        },
    },
    54 => {
...
%Image::ExifTool::Parrot::V3 = (
    ...
    36 => {
        Name => 'FrameBaseView', Format => 'int16s[4]',
        ValueConv => 'my @a = split " ",$val; $_ /= 0x4000 foreach @a; "@a"',
    },
    44 => {
        Name => 'FrameView', Format => 'int16s[4]',
    ...
    60 => {
        Name => 'FOV', Description => 'Field Of View',
...
%Image::ExifTool::Parrot::Automation = (
    ...
    29 => {
        ...
        PrintConv => {
            BITMASK => {
                0 => 'Follow-me enabled',
                1 => 'Look-at-me enabled', 2 => 'Angle locked',
            }
        },
    },
);
...
%Image::ExifTool::Parrot::ARCoreGyro = (
    ...
    4            => {
        ...
        Format  => 'undef[16]',
        Unknown => 1, ValueConv => 'join " ", unpack("Cx4Cx4Cx4C", $val)',
    },
    5 => { Name => 'Gyroscope',
        Format => 'undef[14]',
        RawConv =>
...
%Image::ExifTool::Parrot::Composite = (
    GPSDateTime => {
        ...
        SubDoc      => 1,
        Require     => {
            0 => 'Parrot:GPSLatitude', 1 => 'Main:CreateDate',
            2 => 'SampleTime',
        },
        ValueConv => q{
            my $time = $val[1];
