...
%samsungLensTypes = (
    0 => 'Built-in or Manual Lens',         1 => 'Samsung NX 30mm F2 Pancake',
    2 => 'Samsung NX 18-55mm F3.5-5.6 OIS', 3 =>
      'Samsung NX 50-200mm F4-5.6 ED OIS',
    4 => 'Samsung NX 20-50mm F3.5-5.6 ED', 5 =>
      'Samsung NX 20mm F2.8 Pancake',          6 =>
      'Samsung NX 18-200mm F3.5-6.3 ED OIS',   7 =>
      'Samsung NX 60mm F2.8 Macro ED OIS SSA', 8 =>
      'Samsung NX 16mm F2.4 Pancake', 9 => 'Samsung NX 85mm F1.4 ED SSA', 10 =>
      'Samsung NX 45mm F1.8', 11 => 'Samsung NX 45mm F1.8 2D/3D', 12 =>
      'Samsung NX 12-24mm F4-5.6 ED',                  13 =>
      'Samsung NX 16-50mm F2-2.8 S ED OIS',            14 =>
      'Samsung NX 10mm F3.5 Fisheye',                  15 =>
      'Samsung NX 16-50mm F3.5-5.6 Power Zoom ED OIS', 20 =>
      'Samsung NX 50-150mm F2.8 S ED OIS',             21 =>
...
%Image::ExifTool::Samsung::Main = (
    ...
    2 => {
        ...
        OffsetPair => 3, DataTag => 'PreviewImage',
        IsOffset   => 3,
        Protected  => 2,
...
%Image::ExifTool::Samsung::Type2 = (
    ...
    0x0035 => [
        ...
        {
            Name      => 'PreviewIFD',
            Condition => '$$self{TIFF_TYPE} eq "SRW"', Groups =>
              { 1 => 'PreviewIFD' },
            Flags        => 'SubIFD',
            SubDirectory => {
                TagTable  => 'Image::ExifTool::Nikon::PreviewIFD',
    ...
    0x0040 => { Name => 'RawDataByteOrder',
        PrintConv => {
            0 => 'Little-endian (Intel, II)',
            1 => 'Big-endian (Motorola, MM)', },
    },
    0x0041 => { Name => 'WhiteBalanceSetup',
        Writable  => 'int32u',
        PrintConv => {
            0 => 'Auto',
            1 => 'Manual',
    ...
    0x0043 => { Name => 'CameraTemperature',
        Groups       => { 2 => 'Camera' },
        Writable     => 'rational64s',
        PrintConv    => '$val =~ /\d/ ? "$val C" : $val',
        PrintConvInv => '$val=~s/ ?C//; $val', },
    0x0050 => { Name => 'RawDataCFAPattern',
        PrintConv => {
            0     => 'Unchanged',
            1     => 'Swap',
            65535 => 'Roll',
    ...
    0xa001 => { Name => 'FirmwareName',
        Groups   => { 2 => 'Camera' },
        Writable => 'string', },
    0xa002 => { Name => 'SerialNumber',
        Condition => '$$valPt =~ /^\w{5}/', Groups => { 2 => 'Camera' },
        Writable  => 'string', },
    0xa003 => { Name => 'LensType',
        Groups    => { 2 => 'Camera' },
        Writable  => 'int16u',
        Count     => -1,
        PrintConv => [ \%samsungLensTypes ], },
    0xa004 => { Name => 'LensFirmware',
        Groups   => { 2 => 'Camera' },
        Writable => 'string', },
    0xa005 => {
        Name     => 'InternalLensSerialNumber', Groups => { 2 => 'Camera' },
        Writable => 'string',
    },
    0xa010 => { Name => 'SensorAreas',
        Groups   => { 2 => 'Camera' },
        Notes    => 'full and valid sensor areas',
        Writable => 'int32u',
        Count    => 8, },
    0xa011 => { Name => 'ColorSpace',
        Writable  => 'int16u',
        PrintConv => {
            0 => 'sRGB',
            1 => 'Adobe RGB',
    ...
    0xa012 => { Name => 'SmartRange',
        Writable  => 'int16u',
        PrintConv => { 0 => 'Off', 1 => 'On' }, },
    0xa013 => { Name => 'ExposureCompensation',
        Writable => 'rational64s', },
    0xa014 => { Name => 'ISO',
        Writable => 'int32u', },
    0xa018 => { Name => 'ExposureTime',
    ...
    0xa019 => { Name => 'FNumber',
        ...
        PrintConvInv => '$val', },
    0xa01a => { Name => 'FocalLengthIn35mmFormat',
        Groups       => { 2 => 'Camera' },
        Priority     => 0,
        Format       => 'int32u',
        ValueConv    => '$val / 10',
    ...
    0xa021 => { Name => 'WB_RGGBLevelsUncorrected',
        Writable => 'int32u',
        Count    => 4,
    ...
    0xa040 => { Name => 'ToneCurveSRGBDefault',
        ...
        RawConvInv =>
          'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,"-0",0)', },
    0xa041 => { Name => 'ToneCurveAdobeRGBDefault',
        Writable => 'int32u',
        Count    => 23,
        RawConv =>
          'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,0,"-0")',
    ...
    0xa050 => { Name => 'Distortion',
        ...
        RawConvInv =>
          'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,"-0")', },
    0xa051 => { Name => 'ChromaticAberration',
        Unknown  => 1,
        Writable => 'int16u',
        Count    => 22,
        RawConv =>
    ...
    0xa052 => { Name => 'Vignetting',
        ...
        RawConvInv =>
          'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,"-0",0)', },
    0xa053 => { Name => 'VignettingCorrection',
        Unknown  => 1,
        Writable => 'int16u',
        Count    => 15,
        RawConv =>
    ...
    0xa054 => { Name => 'VignettingSetting',
        ...
        RawConvInv =>
          'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,"-0",0)', },
    0xa055 => { Name => 'Samsung_Type2_0xa055', Unknown => 1,
        Hidden     => 1,
        Writable   => 'int32s',
        Count      => 8,
        RawConv    => 'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,8)',
    ...
    0xa056 => { Name => 'Samsung_Type2_0xa056', Unknown => 1,
        Hidden     => 1,
        Writable   => 'int32s',
        Count      => 8,
    ...
    0xa057 => { Name => 'Samsung_Type2_0xa057', Unknown => 1,
        Hidden     => 1,
        Writable   => 'int32s',
        Count      => 8,
        RawConv    => 'Image::ExifTool::Samsung::Crypt($self,$val,$tagInfo,2)',
...
%Image::ExifTool::Samsung::sec = (
    ...
    0x208 => { Name => 'ThumbnailLength', Format => 'int32u' }, 0x20c => {
        Name   => 'ThumbnailImage',
        Groups => { 2 => 'Preview' },
...
%Image::ExifTool::Samsung::Trailer = (
    ...
    '0x0001-name' => 'EmbeddedImageName', '0x0001' => [
        {
            Name      => 'EmbeddedImage',
    ...
    '0x0a31' => 'SamsungMotionPhotoVersion', '0x0a33' =>
...
'Bonaire, Sint Eustatius and Saba / Curacao / Netherlands Antilles (362)',
    ...
    '0x0ab3' => { Name => 'DualShotExtra',
        SubDirectory =>
          { TagTable => 'Image::ExifTool::Samsung::DualShotExtra' }, },
    '0x0b40' => { Name => 'SingleShotMeta',
        SubDirectory =>
    ...
    '0x0bf0' => 'RemasterInfo',   '0x0c51' =>
      'SamsungCaptureInfo',           '0x0d91' => { Name => 'PEg_Info',
...
sub ProcessSamsung($$;$) {
  ...
  SamBlock:
    for ( ; ; ) {
        ...
        $blockEnd -= $len + 8;
        unless ( $type eq 'SEFT' ) { next unless $outfile and $type eq 'QDIO';
