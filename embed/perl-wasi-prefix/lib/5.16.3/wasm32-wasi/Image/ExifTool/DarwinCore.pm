...
my %event = (
    ...
    fieldNumber => {},
    habitat     => {},
    latestDate  => { %dateTimeInfo, Groups => { 2 => 'Time' } }, month =>
      { Writable => 'integer', Groups => { 2 => 'Time' } },
    parentEventID    => {},
    samplingEffort   => {},
    samplingProtocol => {},
    sampleSizeValue  => {},
...
%Image::ExifTool::DarwinCore::Main = (
    ...
    Occurrence => {
        Struct => {
            ...
            behavior                => {},
            catalogNumber           => {},
            disposition             => {}, establishmentMeans => {},
            individualCount         => {},
            individualID            => {}, lifeStage => {},
            occurrenceDetails       => {},
    ...
    Taxon => {
        Struct => {
            ...
            , genericName => {}, infragenericEpithet => {}, },
    },
    ...
    dctermsLocation     => {
        ...
        FlatName => 'DC', Struct => {
            ...
            georeferenceRemarks                 => {},
            georeferenceSources                 => {},
            georeferenceVerificationStatus      => {}, higherGeography => {},
            higherGeographyID                   => {},
            island                              => {},
            islandGroup                         => {},
            locality                            => {},
