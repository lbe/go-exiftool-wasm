...
%Image::ExifTool::DPX::Main = (
    ...
    0     => {
        Name      => 'ByteOrder',
        Format    => 'undef[4]',
        PrintConv => { SDPX => 'Big-endian', XPDS => 'Little-endian' }
    },
    ...
    801 => { Name => 'TransferCharacteristic',
        Format    => 'int8u',
        PrintConv => {
            0  => 'User-defined',
            1  => 'Printing density',
    ...
    802 => { Name => 'ColorimetricSpecification',
        Format    => 'int8u',
        PrintConv => {
            0  => 'User-defined',
            1  => 'Printing density',
    ...
    1628 => {
        Name    => 'AspectRatio',
        Format  => 'int32u[2]',
        RawConv => '$val =~ /4294967295/ ? undef : $val', PrintConv => q{
