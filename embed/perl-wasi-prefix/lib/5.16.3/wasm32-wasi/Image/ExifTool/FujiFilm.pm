...
'E550, E900, F770, S5600, S6000fd, S6500fd, HS10/HS11, HS30, S200EXR, X100, XF1, X-Pro1, X-S1, XQ2 Ver1.00, X-T100, GFX 50R, XF10',
    ...
    '0201' => 'X-H1 Ver2.01',
    '0212' => 'S3Pro Ver2.12',
    '0216' => 'S3Pro Ver2.16', '0218' => 'S3Pro Ver2.18',
    '0240' => 'X-E1 Ver2.40',
    '0264' => 'F700 Ver2.00',
    '0266' => 'S9500 Ver1.01',
    '0261' => 'X-E1 Ver2.61',
    '0269' => 'S9500 Ver1.02',
    '0271' => 'S3Pro Ver2.71', '0300' => 'X-E2',
    '0540' => 'X-T1 Ver5.40',
    '0712' => 'S5000 Ver3.00',
    '0716' => 'S5000 Ver3.00', '0Dgi' => 'X-A10 Ver1.01 and X-A3 Ver1.02', );
...
%Image::ExifTool::FujiFilm::Main = (
    ...
    0x0010 => { Name => 'InternalSerialNumber',
        Writable => 'string',
        Notes    => q{
...
'$_=$val; s/(\S+) (19|20)(\d{2}):(\d{2}):(\d{2}) /unpack("H*",$1)."$3$4$5"/e; $_',
    ...
    0x1001 => {
        ...
        Writable  => 'int16u',
        PrintConv => {
            0x00 => '-4 (softest)', 0x01 => '-3 (very soft)',
            0x02 => '-2 (soft)',
            0x03 => '0 (normal)',
            0x04 => '+2 (hard)',
            0x05 => '+3 (very hard)',
            0x06 => '+4 (hardest)',
            0x82 => '-1 (medium soft)', 0x84 => '+1 (medium hard)', 0x8000 =>
              'Film Simulation', 0xffff => 'n/a', },
    },
    0x1002 => {
        Name      => 'WhiteBalance',
        Flags     => 'PrintHex',
        ...
        PrintConv => {
            0x0 => 'Auto',
            0x1 => 'Auto (white priority)', 0x2 =>
              'Auto (ambiance priority)', 0x100 => 'Daylight',
            0x200 => 'Cloudy',
            0x300 => 'Daylight Fluorescent',
            0x301 => 'Day White Fluorescent',
            0x302 => 'White Fluorescent',
            0x303 => 'Warm White Fluorescent', 0x304 =>
              'Living Room Warm White Fluorescent', 0x400 => 'Incandescent',
            0x500 => 'Flash',   0x600 => 'Underwater', 0xf00 => 'Custom',
            0xf01 => 'Custom2', 0xf02 => 'Custom3',    0xf03 =>
              'Custom4', 0xf04 => 'Custom5',  0xff0 => 'Kelvin', },
    },
    0x1003 => {
        Name      => 'Saturation',
        Flags     => 'PrintHex',
        Writable  => 'int16u',
        PrintConv => {
            0x0 => '0 (normal)', 0x080 => '+1 (medium high)', 0x100 =>
              '+2 (high)', 0x0c0 => '+3 (very high)',
            0x0e0 => '+4 (highest)',
            0x180 => '-1 (medium low)', 0x200 => 'Low',
            0x300 => 'None (B&W)', 0x301 => 'B&W Red Filter', 0x302 =>
              'B&W Yellow Filter', 0x303 => 'B&W Green Filter', 0x310 =>
              'B&W Sepia', 0x400 => '-2 (low)', 0x4c0 => '-3 (very low)',
            0x4e0 => '-4 (lowest)',
            0x500 => 'Acros', 0x501 => 'Acros Red Filter', 0x502 =>
              'Acros Yellow Filter', 0x503 => 'Acros Green Filter', 0x8000 =>
              'Film Simulation', },
    },
    0x1004 => {
        Name      => 'Contrast',
        ...
        PrintConv => {
            0x0    => 'Normal',
            0x080  => 'Medium High', 0x100 => 'High',
            0x180  => 'Medium Low', 0x200 => 'Low',
            0x8000 => 'Film Simulation', },
    },
    0x1005 => { Name => 'ColorTemperature',
        Writable => 'int16u', },
    0x1006 => { Name => 'Contrast',
        Flags     => 'PrintHex',
        Writable  => 'int16u',
        PrintConv => {
            0x0   => 'Normal',
    ...
    0x100a => { Name => 'WhiteBalanceFineTune',
        Notes => 'newer cameras should divide these values by 20', Writable =>
          'int32s',
        Count        => 2,
        PrintConv    => 'sprintf("Red %+d, Blue %+d", split(" ", $val))',
        PrintConvInv => 'my @v=($val=~/-?\d+/g);"@v"', },
    0x100b => { Name => 'NoiseReduction',
        Flags     => 'PrintHex',
        Writable  => 'int16u',
    ...
    0x100e => { Name => 'NoiseReduction',
        Flags     => 'PrintHex',
        Writable  => 'int16u',
        PrintConv => {
            0x000 => '0 (normal)', 0x100 => '+2 (strong)', 0x180 =>
              '+1 (medium strong)', 0x1c0 => '+3 (very strong)',
            0x1e0 => '+4 (strongest)',
            0x200 => '-2 (weak)', 0x280 => '-1 (medium weak)', 0x2c0 =>
              '-3 (very weak)', 0x2e0 => '-4 (weakest)', },
    },
    0x100f => { Name => 'Clarity',
        Writable => 'int32s', PrintConv => {
            -5000 => '-5',
            -4000 => '-4',
            -3000 => '-3',
            -2000 => '-2',
    ...
    0x1010 => {
        ...
        PrintConv => {
            ...
            2      => 'Off',
            3      => 'Red-eye reduction',
            4      => 'External', 16 => 'Commander',
            0x8000 => 'Not Attached', 0x8120 => 'TTL', 0x8320 =>
              'TTL Auto - Did not fire',
            0x9840 => 'Manual', 0x9860 => 'Flash Commander', 0x9880 =>
              'Multi-flash', 0xa920 => '1st Curtain (front)', 0xaa20 =>
              'TTL Slow - 1st Curtain (front)',                 0xab20 =>
              'TTL Auto - 1st Curtain (front)',                 0xad20 =>
              'TTL - Red-eye Flash - 1st Curtain (front)',      0xae20 =>
              'TTL Slow - Red-eye Flash - 1st Curtain (front)', 0xaf20 =>
              'TTL Auto - Red-eye Flash - 1st Curtain (front)', 0xc920 =>
              '2nd Curtain (rear)',                             0xca20 =>
              'TTL Slow - 2nd Curtain (rear)',                  0xcb20 =>
              'TTL Auto - 2nd Curtain (rear)',                  0xcd20 =>
              'TTL - Red-eye Flash - 2nd Curtain (rear)',       0xce20 =>
              'TTL Slow - Red-eye Flash - 2nd Curtain (rear)',  0xcf20 =>
              'TTL Auto - Red-eye Flash - 2nd Curtain (rear)',  0xe920 =>
              'High Speed Sync (HSS)', },
    },
    0x1011 => {
        Name => 'FlashExposureComp', Writable => 'rational64s',
    },
    0x1020 => {
        Name      => 'Macro',
        Writable  => 'int16u',
    ...
    0x1031 => {
        ...
        Writable  => 'int16u',
        PrintConv => {
            0x0 => 'Auto',  0x1 => 'Portrait',
            0x2 => 'Landscape',
            0x3 => 'Macro', 0x4 => 'Sports',
            0x5 => 'Night Scene',
            0x6 => 'Program AE',
            0x7 => 'Natural Light', 0x8 => 'Anti-blur', 0x9 =>
              'Beach & Snow', 0xa => 'Sunset', 0xb => 'Museum', 0xc =>
              'Party',        0xd => 'Flower', 0xe => 'Text',   0xf =>
              'Natural Light & Flash', 0x10 => 'Beach', 0x11 => 'Snow', 0x12 =>
              'Fireworks',                     0x13 => 'Underwater',    0x14 =>
              'Portrait with Skin Correction', 0x16 => 'Panorama',      0x17 =>
              'Night (tripod)',                0x18 => 'Pro Low-light', 0x19 =>
              'Pro Focus',                     0x1a => 'Portrait 2',    0x1b =>
              'Dog Face Detection', 0x1c => 'Cat Face Detection', 0x30 =>
              'HDR', 0x40 => 'Advanced Filter',
            0x100 => 'Aperture-priority AE',
            0x200 => 'Shutter speed priority AE',
            0x300 => 'Manual',
        },
    },
    0x1032 => { Name => 'ExposureCount',
        Writable => 'int16u',
    ...
    0x1037 => { Name => 'MultipleExposure',
        Writable => 'int16u', PrintConv => {
            1 => 'Additive',
            2 => 'Average',
            3 => 'Light',
            4 => 'Dark',
    ...
    0x1044 => { Name => 'DigitalZoom',
        Writable     => 'int32u',
        ValueConv    => '$val / 8',
        ValueConvInv => '$val * 8', },
    0x1045 => { Name => 'LensModulationOptimizer',
        Writable  => 'int32u',
        PrintConv => { 0 => 'Off', 1 => 'On' }, },
    0x1047 => { Name => 'GrainEffectRoughness',
        Writable  => 'int32s',
        PrintConv => {
            0  => 'Off',
            32 => 'Weak',
    ...
    0x104d => { Name => 'CropMode',
        Writable  => 'int16u',
        PrintConv => { 0 => 'n/a',
            1 => 'Full-frame on GFX', 2 => 'Sports Finder Mode', 4 =>
              'Electronic Shutter 1.25x Crop', 8 => 'Digital Tele-Conv', },
    },
    0x104e => { Name => 'ColorChromeFXBlue',
        Writable  => 'int32s',
        PrintConv => {
            0  => 'Off',
            32 => 'Weak', 64 => 'Strong',
    ...
    0x1050 => { Name => 'ShutterType',
        Writable  => 'int16u',
        PrintConv => {
            0 => 'Mechanical',
            1 => 'Electronic',
            2 => 'Electronic (long shutter speed)', 3 =>
              'Electronic Front Curtain', },
    },
    0x1051 => { Name => 'CropFlag',
        Writable => 'int8u',
        Notes    => q(
            this tag exists only if the image was cropped, and is 0 for cropped JPG
            image or 1 for a cropped RAF
        ), },
    0x1052 => { Name => 'CropTopLeft', Writable => 'int32u' }, 0x1053 =>
      { Name => 'CropSize', Writable => 'int32u' },  0x1100 => [
        {
            Name      => 'AutoBracketing',
        ...
        },
        {
            ...
            PrintConv => {
                0 => 'Off',
                1 => 'On',
                2 => 'No flash & flash', 6 => 'Pixel Shift', },
        }
      ],
    0x1101 => {
        Name     => 'SequenceNumber',
    ...
    0x1102 => { Name => 'WhiteBalanceBracketing',
        Writable  => 'int16u', PrintHex => 1,
        PrintConv => {
            0x01ff => '+/- 1',
            0x02ff => '+/- 2',
            0x03ff => '+/- 3',
    ...
    0x1105 => { Name => 'PixelShiftShots', Writable => 'int16u' }, 0x1106 =>
      { Name => 'PixelShiftOffset', Writable => 'rational64s', Count => 2 }
    , 0x1150 => {
        Name      => 'CompositeImageMode',
        Writable  => 'int32u',
        PrintConv => {
            0 => 'n/a', 1 => 'Pro Low-light', 2 => 'Pro Focus', 32 =>
              'Panorama', 128 => 'HDR', 1024 => 'Multi-exposure', },
    },
    0x1151 => {
    ...
    0x1153 => { Name => 'PanoramaAngle',
        Writable => 'int16u', },
    0x1154 => { Name => 'PanoramaDirection',
        Writable  => 'int16u',
        PrintConv => {
            1 => 'Right',
            2 => 'Left', 3 => 'Up', 4 => 'Down',
    ...
    0x1201 => { Name => 'AdvancedFilter',
        ...
        PrintConv => {
            ...
            0x70000  => 'Soft Focus',
            0x90000  => 'Low Key',
            0x100000 => 'Light Leak', 0x130000 =>
              'Expired Film Green', 0x130001 => 'Expired Film Red', 0x130002 =>
    ...
    0x1401 => { Name => 'FilmMode',
        Writable  => 'int16u',
        PrintHex  => 1,
        PrintConv => {
            0x000 => 'F0/Standard (Provia)', 0x100 => 'F1/Studio Portrait',
            0x110 => 'F1a/Studio Portrait Enhanced Saturation',
            0x120 => 'F1b/Studio Portrait Smooth Skin Tone (Astia)', 0x130 =>
              'F1c/Studio Portrait Increased Sharpness',
            0x200 => 'F2/Fujichrome (Velvia)', 0x300 => 'F3/Studio Portrait Ex',
            0x400 => 'F4/Velvia',
            0x500 => 'Pro Neg. Std', 0x501 => 'Pro Neg. Hi', 0x600 =>
              'Classic Chrome',   0x700 => 'Eterna',        0x800 =>
              'Classic Negative', 0x900 => 'Bleach Bypass', 0xa00 =>
              'Nostalgic Neg',    0xb00 => 'Reala ACE', },
    },
    0x1402 => { Name => 'DynamicRangeSetting',
        Writable  => 'int16u',
        PrintHex  => 1,
        PrintConv => {
            0x000  => 'Auto',
            0x001  => 'Manual', 0x100 => 'Standard (100%)',
            0x200  => 'Wide1 (230%)',
            0x201  => 'Wide2 (400%)',
            0x8000 => 'Film Simulation',
        },
    },
    0x1403 => { Name => 'DevelopmentDynamicRange',
        Writable => 'int16u', },
    0x1404 => { Name => 'MinFocalLength',
        Writable => 'rational64s', },
    0x1405 => { Name => 'MaxFocalLength',
        Writable => 'rational64s', },
    0x1406 => { Name => 'MaxApertureAtMinFocal',
        Writable => 'rational64s', },
    0x1407 => { Name => 'MaxApertureAtMaxFocal',
        Writable => 'rational64s', },
    0x140b => { Name => 'AutoDynamicRange',
        Writable     => 'int16u',
        PrintConv    => '"$val%"',
        PrintConvInv => '$val=~s/\s*\%$//; $val', },
    0x1422 => { Name => 'ImageStabilization',
        Writable  => 'int16u',
        Count     => 3,
        PrintConv => [
            {
                0 => 'None',
                1 => 'Optical', 2 => 'Sensor-shift', 3 => 'OIS Lens', 258 =>
                  'IBIS/OIS + DIS', 512 => 'Digital', },
            {
                0 => 'Off',
    ...
    0x1425 => { Name => 'SceneRecognition',
        Writable  => 'int16u',
        PrintHex  => 1,
        PrintConv => {
            0     => 'Unrecognized',
            0x100 => 'Portrait Image',
            0x103 => 'Night Portrait', 0x105 => 'Backlit Portrait', 0x200 =>
              'Landscape Image',
            0x300 => 'Night Scene',
            0x400 => 'Macro',
        },
    ...
    0x1445 => { Name => 'DRangePriorityFixed',
        Writable  => 'int16u',
        PrintConv => { 1 => 'Weak', 2 => 'Strong' }, },
    0x1446 => { Name => 'FlickerReduction',
        Writable  => 'int32u',
        PrintConv => q{
    ...
    0x144d => { Name => 'RollAngle', Writable => 'rational64s' }, 0x3803 =>
    ...
    0x3804 => { Name => 'PeripheralLighting',
        Groups   => { 2 => 'Video' },
        Writable => 'int16u',
        PrintConv => { 0 => 'Off', 1 => 'On' }, },
    0x3806 => { Name => 'VideoCompression',
        Groups    => { 2 => 'Video' },
        Writable  => 'int16u',
        PrintConv => {
            1 => 'Log GOP',
    ...
    0x3820 => { Name => 'FrameRate',
        Writable => 'int16u',
        Groups   => { 2 => 'Video' }, },
    0x3821 => { Name => 'FrameWidth',
        Writable => 'int16u',
        Groups   => { 2 => 'Video' }, },
    0x3822 => { Name => 'FrameHeight',
        Writable => 'int16u',
        Groups   => { 2 => 'Video' }, },
    0x3824 => { Name => 'FullHDHighSpeedRec',
        Writable  => 'int32u',
        Groups    => { 2 => 'Video' },
        PrintConv => { 1 => 'Off', 2 => 'On' }, },
    0x4005 => { Name => 'FaceElementSelected', Writable => 'int16u',
        Count => 4, },
    0x4100 => { Name => 'FacesDetected',
        Writable => 'int16u', },
    0x4103 => { Name => 'FacePositions',
        Writable => 'int16u',
        Count    => -1,
        Notes    => q{
    ...
    0x4200 => { Name => 'NumFaceElements',
        Writable => 'int16u', },
    0x4201 => { Name => 'FaceElementTypes',
        Writable  => 'int8u',
        Count     => -1,
        PrintConv => [
            {
                ...
                26 => 'Train Front',
                27 => 'Train Cockpit',
                28 => 'Animal Head (28)', 29 => 'Animal Body (29)', },
            'REPEAT'
        ],
    },
    0x4203 => { Name => 'FaceElementPositions',
        Writable => 'int16u',
        Count    => -1,
        Notes    => q{
            left, top, right and bottom coordinates in full-sized image for each face
    ...
    0x4282 => { Name => 'FaceRecInfo',
        SubDirectory =>
          { TagTable => 'Image::ExifTool::FujiFilm::FaceRecInfo' }, },
    0x8000 => { Name => 'FileSource',
        Writable => 'string', },
    0x8002 => { Name => 'OrderNumber',
        Writable => 'int32u', },
    0x8003 => { Name => 'FrameNumber',
        Writable => 'int16u', },
    0xb211 => { Name => 'Parallax',
        Writable => 'rational64s',
...
%Image::ExifTool::FujiFilm::AFCSettings = (
    ...
    0            => {
        Name      => 'AF-CSetting',
        PrintHex  => 3,
        PrintSort => 1,  PrintConv => {
            0x102 => 'Set 1 (multi-purpose)', 0x203 =>
              'Set 2 (ignore obstacles)',           0x122 =>
              'Set 3 (accelerating subject)',       0x010 =>
              'Set 4 (suddenly appearing subject)', 0x123 =>
              'Set 5 (erratic motion)', OTHER => sub {
                my ( $val, $inv ) = @_;
...
%Image::ExifTool::FujiFilm::DriveSettings = (
    ...
    0.1          => {
        ...
        PrintConv => {
            0 => 'Single',
            1 => 'Continuous Low', 2 => 'Continuous High',
        },
    },
    0.2 => {
        Name      => 'DriveSpeed',
...
%Image::ExifTool::FujiFilm::RAFHeader = (
    ...
    0x3c => { Name => 'RAFVersion',
        Format => 'undef[4]', },
    0x6c => { Name => 'RAFCompression',
        Condition => '$$valPt =~ /^\0\0\0/', Format => 'int32u',
...
%Image::ExifTool::FujiFilm::RAF = (
    ...
    0x100 => {
        ...
        Format => 'int16u',
        Groups => { 1 => 'RAF2' }, Count => 2,
        Notes  => 'including borders',
        ValueConv => 'my @v=reverse split(" ",$val);"@v"', PrintConv =>
          '$val=~tr/ /x/; $val',
    },
    0x110 => {
    ...
    0x131 => { Name => 'XTransLayout',
        Description => 'X-Trans Layout',
        Format      => 'int8u',
        Count       => 36,
        PrintConv   => '$val =~ tr/012 /RGB/d; join " ", $val =~ /....../g', },
    0x2000 => { Name => 'WB_GRGBLevelsAuto',
        Format => 'int16u',
        Count  => 4, },
    0x2100 => { Name => 'WB_GRGBLevelsDaylight',
        Format => 'int16u',
        Count  => 4, },
    0x2200 => { Name => 'WB_GRGBLevelsCloudy',
        Format => 'int16u',
        Count  => 4, },
    0x2300 => { Name => 'WB_GRGBLevelsDaylightFluor',
        Format => 'int16u',
        Count  => 4, },
    0x2301 => { Name => 'WB_GRGBLevelsDayWhiteFluor',
        Format => 'int16u',
        Count  => 4, },
    0x2302 => { Name => 'WB_GRGBLevelsWhiteFluorescent',
        Format => 'int16u',
        Count  => 4, },
    0x2310 => { Name => 'WB_GRGBLevelsWarmWhiteFluor',
        Format => 'int16u',
        Count  => 4, },
    0x2311 => { Name => 'WB_GRGBLevelsLivingRoomWarmWhiteFluor',
        Format => 'int16u',
        Count  => 4, },
    0x2400 => { Name => 'WB_GRGBLevelsTungsten',
        Format => 'int16u',
        Count  => 4, },
    0x2ff0 => {
        Name   => 'WB_GRGBLevels',
    ...
    0x9200 => { Name => 'RelativeExposure',
        Format       => 'rational32s',
        ValueConv    => 'log($val) / log(2)',
        ValueConvInv => 'exp($val * log(2))',
        PrintConv    => '$val ? sprintf("%+.1f",$val) : 0',
        PrintConvInv => '$val', },
    0x9650 => { Name => 'RawExposureBias',
        Format       => 'rational32s',
        PrintConv    => '$val ? sprintf("%+.1f",$val) : 0',
        PrintConvInv => '$val', },
    0xc000 => {
...
%Image::ExifTool::FujiFilm::RAFData = (
    ...
    0           => {
        ...
        RawConv =>
          '$val < 10000 ? $$self{FujiWidth} = $val : undef', ValueConv =>
...
%Image::ExifTool::FujiFilm::IFD = (
    ...
    0xf008 => {
        ...
        OffsetPair => 0xf007, },
    0xf00a => 'BlackLevel', 0xf00b => 'GeometricDistortionParams', 0xf00c =>
      'WB_GRBLevelsStandard', 0xf00d => 'WB_GRBLevelsAuto', 0xf00e =>
      'WB_GRBLevels',
    0xf00f => 'ChromaticAberrationParams', 0xf010 => 'VignettingParams',   );
...
%Image::ExifTool::FujiFilm::MOV = (
    ...
    0x3a => { Name => 'ExposureCompensation',
        Format    => 'rational64s',
        PrintConv => '$val ? sprintf("%+.1f", $val) : 0', },
);
