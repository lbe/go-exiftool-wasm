...
%Image::ExifTool::H264::MDPM = (
    ...
    0xb2 => {
        ...
        Combine => 2, ValueConv => 'Image::ExifTool::GPS::ToDegrees($val)',
    ...
    0xb6 => {
        ...
        Format => 'rational32u',
        Groups => { 1 => 'GPS', 2 => 'Location' },
        Combine => 2, Notes => 'combined with tags 0xb7 and 0xb8',
        ValueConv => 'Image::ExifTool::GPS::ToDegrees($val)',
        PrintConv => 'Image::ExifTool::GPS::ToDMS($self, $val, 1)',
    },
    0xb9 => {
        Name   => 'GPSAltitudeRef',
        Format => 'int32u', Groups => { 1 => 'GPS', 2 => 'Location' },
        ValueConv => '$val ? 1 : 0', PrintConv => {
            0 => 'Above Sea Level',
            1 => 'Below Sea Level',
        },
    },
    ...
    0xbb => {
        ...
        Format => 'rational32u',
        Groups => { 1 => 'GPS', 2 => 'Time' },
        Combine => 2, Notes => 'combined with tags 0xbc and 0xbd',
    ...
    0xc7 => {
        ...
        Format => 'string',
        Groups => { 1 => 'GPS', 2 => 'Location' },
        Combine => 1, Notes => 'combined with tag 0xc8',
    },
    0xca => { Name => 'GPSDateStamp',
        Format => 'string',
        Groups => { 1 => 'GPS', 2 => 'Time' },
        Combine => 2, Notes => 'combined with tags 0xcb and 0xcc',
    ...
    0xe4 => { Name => 'Model',
        Condition => '$$self{Make} eq "Sony"', Description =>
          'Camera Model Name',
        Notes   => 'Sony only, combined with tags 0xe5 and 0xe6',
        Format  => 'string',
        Combine => 2, RawConv => '$val eq "" ? undef : $val', },
    0xee => { Name => 'FrameInfo',
        Condition    => '$$self{Make} eq "Canon"',
        Notes        => 'Canon only',
...
%Image::ExifTool::H264::Camera1 = (
    ...
    1.1 => {
        ...
        PrintConv => {
            0 => 'Program AE',
            1 => 'Gain', 2 => 'Shutter speed priority AE',
            3 => 'Aperture-priority AE',
            4 => 'Manual',
        },
    },
...
%Image::ExifTool::H264::Camera2 = (
    ...
    1            => {
        ...
        PrintConv => {
            0     => 'Off',
            0x3f  => 'On (0x3f)', 0xbf => 'Off (0xbf)', 0xff => 'n/a',
            OTHER => sub {
                my $val = shift;
...
%Image::ExifTool::H264::Shutter = (
    ...
    FIRST_ENTRY  => 0,
    FORMAT       => 'int16u',
    1.1          => { Name => 'ExposureTime',
        Mask => 0x7fff, RawConv => '$val == 0x7fff ? undef : $val', ValueConv =>
          '$val / 28125', PrintConv =>
...
%Image::ExifTool::H264::RecInfo = (
    ...
    0            => {
        Name      => 'RecordingMode',
        PrintConv => {
            0x02 => 'XP+', 0x04 => 'SP', 0x05 => 'LP', 0x06 => 'FXP', 0x07 =>
              'MXP', },
    },
);
...
sub ProcessSEI($$) {
    ...
    for ( ; ; ) {
        ...
        if ( $type == 1 ) { if ($parsePictureTiming) {
