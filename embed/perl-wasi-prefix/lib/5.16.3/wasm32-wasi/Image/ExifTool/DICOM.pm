...
%Image::ExifTool::DICOM::Main = (
    ...
    '0028,1211' =>
      { VR => 'OW', Name => 'LargeRedPaletteColorTableData', Binary => 1 },
    '0028,1212' =>
      { VR => 'OW', Name => 'LargeGreenPaletteColorTableData', Binary => 1 },
    '0028,1213' =>
      { VR => 'OW', Name => 'LargeBluePaletteColorTableData', Binary => 1 },
    ...
    'FFFC,FFFC' =>
      { VR => 'OB', Name => 'DataSetTrailingPadding', Binary => 1 },
...
'Mayo Clinic Non-radiological Images Specific Body Structure Anatomical Surface Region Guide',
    ...
    '1.2.840.10008.5.1.1.17.376' =>
      'Printer Configuration RetrievalSOP Instance',
...
'Wide Field Ophthalmic Photography Stereographic Projection Image Storage',
    ...
    '1.2.840.10008.6.1.112' =>
      'Vessel Lumen Cross-sectional Area Calculation Method',
...
'Primary Anatomic Structure for Intra-oral Radiography (Deciduous Dentition - Designation of Teeth)',
    ...
    '1.2.840.10008.6.1.333' =>
      'Change Since Last Mammogram or Prior Surgery from BI-RADS',
    ...
    '1.2.840.10008.6.1.343' =>
      'Calcification Distribution Modifier from BI-RADS',
    ...
    '1.2.840.10008.6.1.475' =>
      'Pathological Regional Lymph Node Assessment for Breast',
    ...
    '1.2.840.10008.6.1.564' =>
      'Estimated Fetal Weight Percentile Equation/Table',
    ...
    '1.2.840.10008.6.1.569' =>
      'Temporal Period Relating to Procedure or Therapy',
    ...
    '1.2.840.10008.6.1.610' =>
      'Echocardiography Congenital Anomaly Measurement',
    ...
    '1.2.840.10008.6.1.828' =>
      'Pediatric, Fetal and Congenital Cardiac Surgical Intervention',
    ...
    '1.2.840.10008.6.1.841' =>
      'Cardiac Ultrasound Pulmonary Artery Measurement',
    ...
    '1.2.840.10008.6.1.844' =>
      'Cardiac Ultrasound Venous Return Pulmonary Measurement',
    '1.2.840.10008.6.1.845' =>
      'Cardiac Ultrasound Venous Return Systemic Measurement',
    ...
    '1.2.840.10008.6.1.849' =>
      'Cardiac Ultrasound Atrioventricular Valve Measurement',
    '1.2.840.10008.6.1.850' =>
      'Cardiac Ultrasound Interventricular Septum Measurement',
    ...
    '1.2.840.10008.6.1.853' =>
      'Cardiac Ultrasound Semilunar Valve, Annulate and Sinus Measurement',
    ...
    '1.2.840.10008.6.1.858' =>
      'Cardiac Ultrasound Pericardium and Pleura Measurement',
    ...
    '1.2.840.10008.6.1.862' =>
      'Cardiac Ultrasound Venous Return Systemic Finding Site',
    ...
    '1.2.840.10008.6.1.866' =>
      'Cardiac Ultrasound Interventricular Septum Finding Site',
    ...
    '1.2.840.10008.6.1.869' =>
      'Cardiac Ultrasound Semilunar Valve, Annulus and Sinus Finding Site',
    ...
    '1.2.840.10008.6.1.874' =>
      'Cardiac Ultrasound Pericardium and Pleura Finding Site',
    ...
    '1.2.840.10008.6.1.919' =>
      'Abstract Multi-dimensional Image Model Dimension Semantic',
...
'Abstract Multi-dimensional Image Model Qualitative Dimension Sample Semantic',
    ...
    '1.2.840.10008.6.1.936' =>
      'Ophthalmic Mapping Unit for Real World Value Mapping',
    ...
    '1.2.840.10008.6.1.952' =>
      'Measurement Derived From Multiple ROI Measurements',
...
'Primary Anatomic Structure for Intra-oral and Craniofacial Radiography - Teeth',
...
'Airway Management Sub-Method Code Type from Anesthesia Quality Initiative',
    ...
    '1.2.840.10008.6.1.1101' =>
      'Temperature Sensor Device Component Type for Small Animal Procedure',
    ...
    '1.2.840.10008.6.1.1134' =>
      'Non-Image Source Instance Purpose of Reference',
...
'Prostate Sector Anatomy from European Concensus 27 Sector (Optimal) Model',
    ...
    '1.2.840.10008.6.1.1183' =>
      'Segmentation Non-Image Source Purpose of Reference',
    ...
    '1.2.840.10008.6.1.1193' =>
      'Morphologically Abnormal Structure Segmentation Property Type',
    '1.2.840.10008.6.1.1194' => 'Function Segmentation Property Type',
    '1.2.840.10008.6.1.1195' =>
      'Spatial and Relational Concept Segmentation Property Type',
    ...
    '1.2.840.10008.6.1.1222' =>
      'Tomotherapeutic Radiotherapy Procedure Technique',
    ...
    '1.2.840.10008.6.1.1229' =>
      'Radiotherapy Accessory Slot Holder Device Type',
    ...
    '1.2.840.10008.6.1.1249' =>
      'Fractionation-based Effective Dose Method Modifier',
    ...
    '1.2.840.10008.6.1.1258' =>
      'Imaging Agent Administration Pharmaceutical Presentation Unit',
    ...
    '1.2.840.10008.6.1.1276' =>
      'Segmented Radiotherapeutic Dose Measurement Device',
    ...
    '1.2.840.10008.6.1.1281' =>
      'Brain Lesion Segmentation Type Without Necrosis',
    ...
    '1.2.840.10008.6.1.1334' =>
      'EMG Annotation - Neurophysiological Enumeration',
    '1.2.840.10008.6.1.1335' =>
      'EOG Annotation - Neurophysiological Enumeration',
    ...
    '1.2.840.10008.6.1.1338' =>
      'EEG Annotation - Neurological Monitoring Measurement',
    ...
    '1.2.840.10008.6.1.1395' =>
      'mpMRI Benign Prostate Abnormality from PI-RADS',
    '1.2.840.10008.6.1.1396' => 'MRI Shape Characteristic',
    '1.2.840.10008.6.1.1397' =>
      'Prostate MRI Shape Characteristic from PI-RADS',
    ...
    '1.2.840.10008.6.1.1401' =>
      'Prostate MRI Signal Characteristic from PI-RADS',
    ...
    '1.2.840.10008.6.1.1409' =>
      'Prostate Cancer Diagnostic Blood Lab Measurement',
    ...
    '1.2.840.10008.6.1.1413' =>
      'Left Ventricle Myocardial Wall 18 Segment Model',
    ...
    '1.2.840.10008.6.1.1445' =>
      'Anatomically Localized Lesion Segmentation Type',
    ...
    '1.2.840.10008.6.1.1514' =>
      'Diagnostic Imaging Procedure without IV Contrast',
    ...
    '1.2.840.10008.6.1.1528' =>
      'Structural Heart Measurement Report Document Title',
    ...
    '1.2.840.10008.6.1.1532' =>
      'Cardiac Structure Calcification Qualitative Evaluation',
...
sub ProcessDICOM($$) {
    ...
    $raf->Read( $hdr, 12 ) == 12 or return 0;
    $raf->Seek( 128, 0 ) or return 0;
    ...
    if ( $buff eq 'DICM' ) {
        ...
        foreach ( 'II', 'MM', '' ) {
            ...
            if ( $vr =~ /^[A-Z]{2}$/ ) {
                $implicit = 0;
                if ( $vr32{$vr} ) {
                    next unless Get16u( \$hdr, 6 ) == 0;
                    $len = Get32u( \$hdr, 8 );
                }
                else {
                    next if $e == 0 and $vr ne 'UL';
                    $len = Get16u( \$hdr, 6 );
                }
            }
            else {
    ...
    for ( ; ; ) {
        ...
        if (
            $transferSyntax
            and ( $group != 0x0002
                or ( $group2end and $pos > $group2end ) )
          )
        {
            unless (
                $transferSyntax =~ /^1\.2\.840\.10008\.1\.2(\.\d+)?(\.\d+)?/ )
            {
            ...
            if ( not $1 ) {
                ...
                if ( eval { require Compress::Zlib } ) {
                    ...
                    my $inflate =
                      Compress::Zlib::inflateInit( -WindowBits => $wbits );
                    if ($inflate) {
                        ...
                        while ( $raf->Read( $buff, 65536 ) ) {
                                ...
                                or $stat == Compress::Zlib::Z_STREAM_END() )
                            {
                                ...
                                $et->Warn(
                                    'Error inflating compressed data stream');
                                return 1;
                            }
                        }
                    ...
                    $et->Warn(
'Install Compress::Zlib to decode compressed data stream'
                    );
                    return 1;
                }
            }
        ...
        unless ($tagInfo) {
            my $xx;
            if (   ( ( $xx = $tag ) =~ s/^(..)../$1xx/ and $$tagTablePtr{$xx} )
                or ( ( $xx = $tag ) =~ s/..$/xx/        and $$tagTablePtr{$xx} )
                or ( ( $xx = $tag ) =~ s/.(.)$/x$1/     and $$tagTablePtr{$xx} )
                or ( ( $xx = $tag ) =~ s/...(.)$/xxx$1/ and $$tagTablePtr{$xx} )
                or ( ( $xx = $tag ) =~ s/....$/xxxx/ and $$tagTablePtr{$xx} ) )
            {
                $tag     = $xx;
                $tagInfo = $$tagTablePtr{$xx};
            }
            elsif ($unknown) {
                if ( $element == 0 ) { $tagInfo = {
                    ...
                    $tagInfo = {
                        ...
                        Description =>
                          sprintf( "DICOM %.4X,%.4X", $group, $element ),
                    };
                }
                $$tagInfo{Unknown} = 1;
...
s/^ *(\d{4})(\d{2})(\d{2})(\d{2})(\d{2})(\d{2}[^ ]*)/$1:$2:$3 $4:$5:$6/;
                ...
                if ($tagInfo) {
                    ...
                    $$tagInfo{Hidden} = '' unless defined $$tagInfo{Hidden};
                }
            }
