...
my %funcButtonZ6 = ( 1 => 'AF-On or Subject Tracking', 2 => 'AF Lock Only',
    3  => 'AE Lock (hold)',
    ...
    16 => 'Synchronized Release (Remote)', 19 => '+NEF(RAW)',
...
my %previewButtonD6 = (
    ...
    36 => 'Synchronized Release (Remote)', 39 => '+NEF(RAW)',
    40 => 'Grid Display',
    41 => 'Virtual Horizon',
    42 => 'Voice Memo',
    43 => 'Wired LAN',
...
%Image::ExifTool::NikonSettings::Main = (
    ...
    0x022 => {
      ...
      }, 0x025 => { Name => 'ManualFocusPointIllumination',
        PrintConv => {
            1 => 'On',
            2 => 'On During Focus Point Selection Only',
        },
      },
    0x026 => { Name => 'AF-AssistIlluminator', PrintConv => \%onOff }, 0x027 =>
      { Name => 'ManualFocusRingInAFMode', PrintConv => \%onOff }, 0x029 =>
      { Name => 'ISOStepSize', PrintConv => \%thirdHalfFull }, 0x02a =>
      { Name => 'ExposureControlStepSize', PrintConv => \%thirdHalfFull }
    , 0x02b => { Name => 'EasyExposureCompensation',
        PrintConv => {
            1 => 'On (auto reset)',
            2 => 'On',
            3 => 'Off',
    ...
    0x02f => { Name => 'FineTuneOptMatrixMetering',
        ValueConv    => '($val - 7) / 6',
        ValueConvInv => 'int($val*6+7)',
        PrintConv    => '$val ? sprintf("%+.2f", $val) : 0',
        PrintConvInv => 'Image::ExifTool::Exif::ConvertFraction($val)', },
    0x030 => { Name => 'FineTuneOptCenterWeighted',
        ValueConv    => '($val - 7) / 6',
        ValueConvInv => 'int($val*6+7)',
        PrintConv    => '$val ? sprintf("%+.2f", $val) : 0',
        PrintConvInv => 'Image::ExifTool::Exif::ConvertFraction($val)', },
    0x031 => { Name => 'FineTuneOptSpotMetering',
        ValueConv    => '($val - 7) / 6',
        ValueConvInv => 'int($val*6+7)',
        PrintConv    => '$val ? sprintf("%+.2f", $val) : 0',
        PrintConvInv => 'Image::ExifTool::Exif::ConvertFraction($val)', },
    0x032 => { Name => 'FineTuneOptHighlightWeighted',
        ValueConv    => '($val - 7) / 6',
        ValueConvInv => 'int($val*6+7)',
        PrintConv    => '$val ? sprintf("%+.2f", $val) : 0',
        PrintConvInv => 'Image::ExifTool::Exif::ConvertFraction($val)', },
    0x033 => { Name => 'ShutterReleaseButtonAE-L',
        PrintConv => {
            1 => 'On (Half Press)',
            2 => 'On (Burst Mode)',
            3 => 'Off',
    ...
    0x036 => {
        ...
        ValueConv    => '10 - $val',
        ValueConvInv => '10 + $val'
      }, 0x037 => { Name => 'SelfTimerShotInterval',
        PrintConv => {
            1 => '0.5 s',
            2 => '1 s',
            3 => '2 s',
    ...
    , 0x03a => {
      ...
      }, 0x03b => { Name => 'ImageReviewMonitorOffTime',
        PrintConv => {
            1 => '2 s',
            2 => '4 s',
            3 => '10 s',
    ...
    0x03c => { Name => 'LiveViewMonitorOffTime',
        PrintConv => {
            1 => '5 min',
            2 => '10 min',
            3 => '15 min',
    ...
    0x03e => {
      ...
      }, 0x03f => { Name => 'MaxContinuousRelease' }, 0x040 =>
    ...
    , 0x042 => { Name => 'FileNumberSequence', PrintConv => \%onOff }, 0x043 =>
      { Name => 'FramingGridDisplay', PrintConv => \%onOff }, 0x045 =>
      { Name => 'LCDIllumination',    PrintConv => \%onOff }, 0x046 =>
      { Name => 'OpticalVR',          PrintConv => \%onOff }, 0x047 => [
        { Name => 'FlashSyncSpeed',
            PrintConv => {
                1 => '1/250 s (auto FP)',
                2 => '1/250 s',
    ...
    0x049 => {
      ...
      }, 0x04a => { Name => 'AutoFlashISOSensitivity',
        PrintConv => {
            1 => 'Subject and Background',
            2 => 'Subject Only',
        },
      },
    0x051 => { Name => 'AssignBktButton',
        PrintConv => {
            1 => 'Auto Bracketing',
            2 => 'Multiple Exposure',
    ...
    0x056 => { Name => 'MultiSelectorLiveView',
        PrintConv => {
            1 => 'Select Center Focus Point',
            2 => 'Zoom (Low)',
            3 => 'Zoom (1:1)',
    ...
    0x058 => { Name => 'CmdDialsReverseRotExposureComp',
        RawConv => '$$self{CmdDialsReverseRotExposureComp} = $val',
        Unknown => 1, },
    0x059 => { Name => 'CmdDialsChangeMainSubExposure',
...
'$$self{CmdDialsChangeMainSubExposure} and $$self{CmdDialsChangeMainSubExposure} == 2',
    ...
    0x05b => {
      ...
      }, 0x05c => { Name => 'SubDialFrameAdvance',
        PrintConv => {
            1 => '10 Frames',
            2 => '50 Frames',
            3 => 'Rating',
    ...
    0x074 => {
      ...
      }, 0x075 => { Name => 'HDMIOutputResolution',
        PrintConv => {
            1 => 'Auto',
            2 => '2160p',
            3 => '1080p',
...
'$$self{CmdDialsReverseRotExposureComp} and $$self{CmdDialsReverseRotExposureComp} == 1',
    ...
    0x08d => { Name => 'FocusPeakingHighlightColor',
        PrintConv => {
            1 => 'Red',
            2 => 'Yellow',
            3 => 'Blue',
    ...
    , 0x08f => { Name => 'ShutterSpeedLock', PrintConv => \%onOff }, 0x090 =>
      { Name => 'ApertureLock', PrintConv => \%onOff }, 0x091 =>
    ...
    0x092 => { Name => 'HDMIExternalRecorder', PrintConv => \%onOff }, 0x093 =>
    ...
    0x094 => {
      ...
      { Name => 'Three-DTrackingFaceDetection', PrintConv => \%onOff }
    , 0x097 => [
    ...
    0x099 => { Name => 'DynamicAreaAFAssist', PrintConv => \%onOff }, 0x09a =>
      { Name => 'ExposureCompStepSize', PrintConv => \%thirdHalfFull }
    , 0x09b => {
        Name      => 'SyncReleaseMode',
        PrintConv => { 1 => 'Sync', 2 => 'No Sync' }
      }, 0x09c => { Name => 'ModelingFlash', PrintConv => \%onOff }, 0x09d =>
    ...
    0x0a4 => { Name => 'SubSelector', PrintConv => \%tagSubSelector }, 0x0a5 =>
      [
    ...
    , 0x0aa => { Name => 'LiveViewButtonOptions',
        PrintConv => {
            1 => 'Enable',
    ...
    0x0b3 => [
        ...
        { Name => 'MovieFunc2Button',
            PrintConv => { 1 => 'Power Aperture (Close)',
                2  => 'Exposure Compensation',
                3  => 'Subject Tracking',
                4  => 'LiveView Info Display On/Off',
                5  => 'Grid Display',
    ...
    , 0x0d6 => {
        ...
        PrintConv => \%limitNolimit,
        Unknown   => 1
      }, 0x0da => { Name => 'LowLightAF', PrintConv => \%onOff }, 0x0db => {
    ...
    0x0ed => [
        ...
        { Name => 'MovieMultiSelector',
            PrintConv => { 1 => 'Center Focus Point',
                2 => 'Zoom (Low)',
                3 => 'Zoom (1:1)',
                4 => 'Zoom (High)',
                5 => 'Record Movie',
    ...
    0x0ee => {
        ...
        ValueConv    => '$val - 6',
        ValueConvInv => '$val + 6'
      }, 0x0ef => { Name => 'MovieAFSpeedApply',
        PrintConv => {
            1 => 'Always',
            2 => 'Only During Recording',
        },
      },
    0x0f0 => { Name => 'MovieAFTrackingSensitivity',
        PrintConv => {
            1 => '1 (High)',
            2 => '2',
            3 => '3',
    ...
    0x0f1 => { Name => 'MovieHighlightDisplayPattern',
        PrintConv => {
            1 => 'Pattern 1',
            2 => 'Pattern 2',
            3 => 'Off',
    ...
    0x103 => { Name => 'HDMIOutputHDR',
        Condition => '$$self{HDMIBitDepth}  == 2', RawConv =>
          '$$self{HDMIOutputHDR} = $val',
        PrintConv => {
            2 => 'On', 3 => 'Off',
        },
    },
    0x104 => { Name => 'HDMIViewAssist',
        Condition => '$$self{HDMIBitDepth}  == 2',
        PrintConv => \%onOff },
    0x109 => { Name => 'BracketSet',
    ...
    , 0x118 => {
        ...
        PrintConv => \%limitNolimit,
        Unknown   => 1
      }, 0x11d => { Name => 'AutoFocusModeRestrictions',
        PrintConv => {
            1 => 'AF-S',
            2 => 'AF-C',
            3 => 'No Limit',
    ...
    0x11e => { Name => 'FocusPointBrightness',
        PrintConv => {
            1 => 'Extra High',
            2 => 'High',
            3 => 'Normal',
    ...
    0x11f => {
        ...
        PrintConv    => '"$val fps"',
        PrintConvInv => '$val=~s/\s*fps//i; $val'
      }, 0x121 => { Name => 'QuietShutterShootingSpeed',
        PrintConv => {
            1 => 'Single',
            2 => '5 fps',
            3 => '4 fps',
    ...
    0x122 => {
      ...
      { Name => 'RecallShootFuncExposureMode', PrintConv => \%offOn }, 0x12b =>
      { Name => 'RecallShootFuncShutterSpeed', PrintConv => \%offOn }, 0x12c =>
      { Name => 'RecallShootFuncAperture',     PrintConv => \%offOn }, 0x12d =>
      { Name => 'RecallShootFuncExposureComp', PrintConv => \%offOn }, 0x12e =>
      { Name => 'RecallShootFuncISO',          PrintConv => \%offOn }, 0x12f =>
      { Name => 'RecallShootFuncMeteringMode', PrintConv => \%offOn }, 0x130 =>
      { Name => 'RecallShootFuncWhiteBalance', PrintConv => \%offOn }, 0x131 =>
      { Name => 'RecallShootFuncAFAreaMode',   PrintConv => \%offOn }, 0x132 =>
      { Name => 'RecallShootFuncFocusTracking', PrintConv => \%offOn }
    , 0x133 => { Name => 'RecallShootFuncAF-On', PrintConv => \%offOn }
    , 0x134 => { Name => 'VerticalFuncButton',
        PrintConv => {
    ...
    0x136 => { Name => 'VerticalAF-OnButton',
        PrintConv => {
            1  => 'AF-AreaMode S',
            2  => 'AF-AreaMode D9',
            3  => 'AF-AreaMode D25',
    ...
    , 0x159 => { Name => 'EnergySavingMode', PrintConv => \%onOff }, 0x15c =>
      { Name => 'BracketingBurstOptions', PrintConv => \%enableDisable }
    ,  0x15e => {
        Name      => 'PrimarySlot',
    ...
    ,  0x164 => { Name => 'VerticalMovieFuncButton',
        PrintConv => {
    ...
    0x165 => { Name => 'VerticalMovieAFOnButton',
        PrintConv => {
            1  => 'Same as AF-On',
    ...
    0x169 => {
        ...
        PrintConv => \%limitNolimit,
        Unknown   => 1
      }, 0x16d => { Name => 'SaveFocus', PrintConv => \%onOff }, 0x16e =>
      { Name => 'AFAreaMode',
    ...
    , 0x171 => { Name => 'KeepExposureWithTeleconverter',
        PrintConv => {
            1 => 'Off',
            2 => 'Shutter Speed',
            3 => 'ISO',
    ...
    0x174 => { Name => 'FocusPointSelectionSpeed',
        PrintConv => {
            1 => 'Normal',
            2 => 'High',
            3 => 'Very High',
