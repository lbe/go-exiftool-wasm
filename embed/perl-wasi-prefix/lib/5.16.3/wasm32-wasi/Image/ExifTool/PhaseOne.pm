...
%Image::ExifTool::PhaseOne::Main = (
    ...
    VARS => { ENTRY_SIZE => 16 }, NOTES =>
      'These tags are extracted from the maker notes of Phase One images.',
    0x0100 => { Name => 'CameraOrientation',
        ValueConv => '$val & 0x03', PrintConv => {
            0 => 'Horizontal (normal)',
            1 => 'Rotate 90 CW',
            2 => 'Rotate 270 CW',
            3 => 'Rotate 180',
    ...
    0x0108 => 'SensorWidth',
    0x0109 => 'SensorHeight',
    0x010a => 'SensorLeftMargin', 0x010b => 'SensorTopMargin', 0x010c =>
      'ImageWidth',
    0x010d => 'ImageHeight',
    0x010e => { Name => 'RawFormat',
        PrintConv => { 0 => 'Uncompressed', 1 => 'RAW 1', 2 => 'RAW 2', 3 =>
              'IIQ L',  5 => 'IIQ S',
            6 => 'IIQ Sv2', 8 => 'IIQ L16', },
    },
    0x010f => {
    ...
    0x0112 => {
        ...
        Format      => 'int32u',
        Writable    => 0, Priority => 0,
        Shift       => 'Time',
        Groups => { 2 => 'Time' },
        Notes => 'may be used as a key to encrypt the raw data', ValueConv =>
          'ConvertUnixTime($val)',
        ValueConvInv => 'GetUnixTime($val)',
        PrintConv    => '$self->ConvertDateTime($val)',
        PrintConvInv => '$self->InverseDateTime($val)',
    },
    0x0113 => 'ImageNumber', 0x0203 =>
      { Name => 'Software', Format => 'string' },
    0x0204 => { Name => 'System', Format => 'string' },
    0x0210 => { Name => 'SensorTemperature',
        Format       => 'float',
        PrintConv    => 'sprintf("%.2f C",$val)',
        PrintConvInv => '$val=~s/ ?C//; $val', },
    0x0211 => { Name => 'SensorTemperature2',
        Format       => 'float',
        PrintConv    => 'sprintf("%.2f C",$val)',
        PrintConvInv => '$val=~s/ ?C//; $val', },
    0x0212 => {
    ...
    0x021d => 'BlackLevel',    0x0222 => 'SplitColumn', 0x0223 => {
        Name   => 'BlackLevelData',
        Format => 'int16u',
        Count  => -1,
        Binary => 1
    ...
    0x0267 => { Name => 'AFAdjustment',
        Format => 'float', },
    0x022b => { Name => 'PhaseOne_0x022b',
        Format => 'float',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0258 => { Name => 'PhaseOne_0x0258',
        Format    => 'int16s',
        Flags     => [ 'Unknown', 'Hidden' ],
        PrintConv => \&Image::ExifTool::LimitLongValues, },
    0x025a => { Name => 'PhaseOne_0x025a',
        Format    => 'int16s',
        Flags     => [ 'Unknown', 'Hidden' ],
        PrintConv => \&Image::ExifTool::LimitLongValues, },
...
%Image::ExifTool::PhaseOne::SensorCalibration = (
    ...
    0x0404 => { Name => 'SensorCalibration_0x0404',
        Format => 'string',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0405 => { Name => 'SensorCalibration_0x0405',
        Format => 'string',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0406 => { Name => 'SensorCalibration_0x0406',
        Format => 'string',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0407 => { Name => 'SerialNumber',
        Format   => 'string',
        Writable => 1, },
    0x0408 => { Name => 'SensorCalibration_0x0408',
        Format => 'float',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x040b => {
    ...
    0x040f => { Name => 'SensorCalibration_0x040f',
        Format => 'undef',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0410 => {
    ...
    0x0413 => { Name => 'SensorCalibration_0x0413',
        Format => 'double',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0414 => { Name => 'SensorCalibration_0x0414',
        Format    => 'undef',
        Flags     => [ 'Unknown', 'Hidden' ],
        ValueConv => q{
    ...
    0x0418 => { Name => 'SensorCalibration_0x0418',
        Format => 'undef',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x0419 => {
    ...
    0x041c => { Name => 'SensorCalibration_0x041c',
        Format => 'float',
        Flags  => [ 'Unknown', 'Hidden' ], },
    0x041e => { Name => 'SensorCalibration_0x041e',
        Format    => 'undef',
        Flags     => [ 'Unknown', 'Hidden' ],
        ValueConv => q{
            my $order = GetByteOrder();
