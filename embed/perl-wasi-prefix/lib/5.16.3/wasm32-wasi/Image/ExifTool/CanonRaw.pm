...
%Image::ExifTool::CanonRaw::Main = (
    ...
    WRITABLE     => 1,
    0x0000 => { Name => 'NullRecord', Writable => 'undef' }, 0x0001 =>
      { Name => 'FreeBytes',
        Format => 'undef',
        Binary => 1, },
    ...
    0x080c => { Name => 'ComponentVersion', Writable => 'string' }, 0x080d =>
      { Name => 'ROMOperationMode', Writable => 'string[8]' }, 0x0810 =>
      { Name => 'OwnerName', Writable => 'string[32]' },
    ...
    0x1010 => { Name => 'ShutterReleaseMethod',
        Writable  => 'int16u',
        PrintConv => {
            0 => 'Single Shot',
    ...
    0x1011 => { Name => 'ShutterReleaseTiming',
        Writable  => 'int16u',
        PrintConv => {
    ...
    0x1016 => { Name => 'ReleaseSetting', Writable => 'int16u' }, 0x101c =>
      { Name => 'BaseISO', Writable => 'int16u' }, 0x1028 =>
      { Name => 'CanonFlashInfo',
        Writable => 'int16u',
        Count    => 4,
        Unknown  => 1, },
...
'Image::ExifTool::Canon::Validate($dirData,$subdirStart,$size)',
    ...
    0x1803 => { Name => 'ImageFormat',
        Writable => 0,
        SubDirectory =>
          { TagTable => 'Image::ExifTool::CanonRaw::ImageFormat' }, },
    0x1804 => { Name => 'RecordID', Writable => 'int32u' }, 0x1806 =>
      { Name => 'SelfTimerTime',
        Writable     => 'int32u',
        ValueConv    => '$val / 1000',
    ...
    0x180e => {
        Name         => 'TimeStamp',
        Writable     => 0,
        SubDirectory => { TagTable => 'Image::ExifTool::CanonRaw::TimeStamp', },
    },
    0x1810 => {
        Name         => 'ImageInfo',
        Writable     => 0,
        SubDirectory => { TagTable => 'Image::ExifTool::CanonRaw::ImageInfo', },
    },
    0x1813 => { Name => 'FlashInfo',
        Writable     => 0,
        SubDirectory => { TagTable => 'Image::ExifTool::CanonRaw::FlashInfo', },
    },
    0x1814 => { Name => 'MeasuredEV',
        Notes => q{
    ...
    0x1818 => { Name => 'ExposureInfo',
        Groups => { 1 => 'CIFF' }, Writable => 0,
        SubDirectory =>
          { TagTable => 'Image::ExifTool::CanonRaw::ExposureInfo' }, },
    0x1834 => { Name => 'CanonModelID',
        Writable => 'int32u',
        PrintHex => 1,
        Notes    => q{
    ...
    0x183b => {  Name => 'SerialNumberFormat',
        Writable  => 'int32u',
        PrintHex  => 1,
        PrintConv => {
            0x90000000 => 'Format 1',
    ...
    0x2007 => {
        Name     => 'JpgFromRaw',
        Groups   => { 2 => 'Preview' },
        Writable => 'resize', Permanent => 0,
        RawConv  => '$self->ValidateImage(\$val,$tag)',
    },
    0x2008 => {
        Name      => 'ThumbnailImage',
        Groups    => { 2 => 'Preview' },
        Writable  => 'resize', WriteCheck => '$self->CheckImage(\$val)',
        Permanent => 0,
        RawConv   => '$self->ValidateImage(\$val,$tag)',
    },
    0x2804 => {
    ...
    0x2807 => { Name => 'CameraObject',
        SubDirectory => {},
        Writable     => 0, },
    0x3002 => { Name => 'ShootingRecord',
        SubDirectory => {},
        Writable     => 0, },
    0x3003 => { Name => 'MeasuredInfo',
        SubDirectory => {},
        Writable     => 0, },
    0x3004 => { Name => 'CameraSpecification',
        SubDirectory => {},
        Writable     => 0, },
    0x300a => { Name => 'ImageProps',
        SubDirectory => {},
        Writable     => 0, },
    0x300b => {
...
%Image::ExifTool::CanonRaw::MakeModel = (
    ...
    DATAMEMBER   => [ 0, 6 ], WRITABLE => 1,
    FORMAT       => 'string',
    GROUPS       => { 0 => 'MakerNotes', 2 => 'Camera' },
    0            => {
        Name    => 'Make',
        Format  => 'string[6]', DataMember => 'Make',
        RawConv => '$self->{Make} = $val',
    },
    6 => {
        Name       => 'Model',
        Format     => 'string', Description => 'Camera Model Name',
        DataMember => 'Model',
...
%Image::ExifTool::CanonRaw::ImageInfo = (
    ...
    FIRST_ENTRY  => 0,
    GROUPS       => { 0 => 'MakerNotes', 2 => 'Image' },
    0 => 'ImageWidth', 1 => 'ImageHeight', 2 => { Name => 'PixelAspectRatio',
        Format => 'float', },
    3 => {
        Name     => 'Rotation',
        Format   => 'int32s',
    ...
    4 => 'ComponentBitDepth', 5 => 'ColorBitDepth', 6 => 'ColorBW', );
...
sub ProcessCanonRaw($$$) {
    ...
    for ( $index = 0 ; $index < $entries ; ++$index ) {
        ...
        my ( $value, $delRawConv );
        if ($valueInDir) {  $valueDataPos = $dirOffset + $pt + 4;
            $size  = 8;
