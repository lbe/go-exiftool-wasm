...
%Image::ExifTool::SonyIDC::Main = (
    ...
    0x8018 => {
        Name      => 'BrightnessAdj',
        Writable  => 'int32s',
        PrintConv => 'sprintf("%.2f", $val/300)', PrintConvInv => '$val * 300',
    },
    ...
    0x8040 => { Name => 'DistortionCompensation',
        Writable  => 'int32s',
        PrintConv => {
            -1 => 'n/a', 1 => 'On',
            2  => 'Off',
    ...
    0x900d => { Name => 'ChromaticAberrationCorrection', Writable => 'int32s',
        PrintConv => { 1 => 'On', 2 => 'Off' }, },
    0x900e => { Name => 'InclinationCorrection',
        Writable  => 'int32u',
        PrintConv => { 0 => 'Off', 1 => 'On' }, },
    0x900f => { Name => 'InclinationAngle',
        Writable     => 'int32s',
        PrintConv    => 'sprintf("%.1f deg", $val/1000)',
        PrintConvInv => 'ToFloat($val) * 1000', },
    0x9010 => { Name => 'Cropping',
        Writable  => 'int32u',
        PrintConv => { 0 => 'Off', 1 => 'On' }, },
    0x9011 => { Name => 'CropArea',
        Writable => 'int32u',
        Count    => 4, },
    0x9012 => { Name => 'PreviewImageSize',
        Writable => 'int32u',
        Count    => 2, },
    0x9013 => { Name => 'PxShiftPeriphEdgeNR',
        Writable  => 'int32s',
        PrintConv => { 0 => 'Off', 1 => 'On' }, },
    0x9014 => { Name => 'PxShiftPeriphEdgeNRValue',
        Writable     => 'int32s',
        PrintConv    => 'sprintf("%.1f", $val/10)',
        PrintConvInv => '$val * 10', },
    0x9017 => { Name => 'WhitesAdj', Writable => 'int32s' }, 0x9018 =>
      { Name => 'BlacksAdj',     Writable => 'int32s' }, 0x9019 =>
      { Name => 'HighlightsAdj', Writable => 'int32s' }, 0x901a =>
      { Name => 'ShadowsAdj',    Writable => 'int32s' }, 0xd000 =>
      { Name => 'CurrentVersion', Writable => 'int32u' },
    0xd001 => {
        Name   => 'VersionIFD',
        Groups => { 1 => 'Version0' },
        Flags  => 'SubIFD',
