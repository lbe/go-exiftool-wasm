...
my %vrdFormat = (
    ...
    9  => 'int32s',
    13 => 'double',
    24 => 'int32s', 33 => 'int32u', 38 => 'double',  255 => 'undef',
);
...
%Image::ExifTool::CanonVRD::Edit = (
    ...
    VARS => { ID_LABEL => 'Index' }, NOTES => 'Canon VRD edit information.',
    0    => {
        Name => 'VRD1',
        Size => 0x272, SubDirectory =>
          { TagTable => 'Image::ExifTool::CanonVRD::Ver1' },
    },
    1 => {
        Name => 'VRDStampTool',
        Size => 0, SubDirectory =>
          { TagTable => 'Image::ExifTool::CanonVRD::StampTool' },
    },
    2 => {
        Name => 'VRD2',
        Size => undef, SubDirectory =>
          { TagTable => 'Image::ExifTool::CanonVRD::Ver2' },
    },
);
...
%Image::ExifTool::CanonVRD::Edit4 = (
    WRITE_PROC   => \&ProcessEditData,
    PROCESS_PROC => \&ProcessEditData,
    VARS         => { ID_LABEL => 'Index' }, NOTES =>
      'Canon DPP version 4 edit information.',
    0 => {
        Name => 'DR4',
        Size => undef, SubDirectory =>
          { TagTable => 'Image::ExifTool::CanonVRD::DR4' },
    },
);
...
%Image::ExifTool::CanonVRD::Ver1 = (
    ...
    WRITABLE     => 1,
    PERMANENT    => 1, FIRST_ENTRY => 0,
    GROUPS => { 2 => 'Image' },
    DATAMEMBER => [0x002], 0x002 => {
        Name       => 'VRDVersion',
        Format     => 'int16u',
        Writable   => 0,
...
%Image::ExifTool::CanonVRD::Ver2 = (
    ...
    PERMANENT    => 1, FIRST_ENTRY => 0,
    FORMAT       => 'int16s',
    DATAMEMBER   => [ 0x58, 0xdc, 0xdf, 0xe0 ], IS_SUBDIR => [0xe0],
    GROUPS => { 2 => 'Image' },
    ...
    0x14 => 'StandardOutputHighlightPoint', 0x15 =>
      'StandardOutputShadowPoint', 0x16 => 'PortraitRawColorTone',
    ...
    0x6d => { Name => 'LuminanceNR_TIFF_JPEG',
        Notes        => 'val = raw / 10',
        ValueConv    => '$val / 10',
...
%Image::ExifTool::CanonVRD::DLOInfo = (
    ...
    0x05         => {
        Name => 'DLOVersion', Format => 'string[10]',
    },
    0x0a => {
        Name     => 'DLOData',
        LargeTag => 1, Notes =>
...
%Image::ExifTool::CanonVRD::DR4 = (
    ...
    WRITABLE     => 1,
    PERMANENT    => 1, GROUPS => { 1 => 'CanonDR4', 2 => 'Image' },
    ...
    0x10002 => 'Rotation', 0x10003 => 'AngleAdj',   0x10021 =>
      'CustomPictureStyle', 0x10100 => { Name => 'Rating',
        PrintConv => {
            0          => 'Unrated',
            1          => 1,
            2          => 2,
    ...
    0x20125 => {
        Name      => 'WBAdjRGGBLevels',
        PrintConv => '$val =~ s/^\d+ //; $val', PrintConvInv => '"14 $val"',
    },
    ...
    0x20b10 => 'DPRAWMicroadjustBackFront', 0x20b12 =>
      'DPRAWMicroadjustStrength', 0x20b20 => 'DPRAWBokehShift', 0x20b21 =>
      'DPRAWBokehShiftArea', 0x20b30 =>
      'DPRAWGhostingReductionArea', 0x30101 => {
        Name      => 'CropAspectRatio',
        PrintConv => {
            0  => 'Free',
            1  => 'Custom',
