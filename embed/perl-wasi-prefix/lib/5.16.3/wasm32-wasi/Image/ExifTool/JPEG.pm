...
%Image::ExifTool::JPEG::Main = (
    ...
    APP1 => [
        ...
        {
            Name => 'RawThermalImage', Condition =>
              '$$valPt =~ /^PARROT\0(II\x2a\0|MM\0\x2a)/',
    ...
    APP3 => [
        ...
        {
            Name => 'ThermalData', Condition => '$$self{Make} eq "DJI"',
            Notes  => 'DJI raw thermal data',
            Groups => { 0 => 'APP3', 1 => 'DJI', 2 => 'Image' },
            Binary => 1,
        },
        {
            Name => 'ImagingData', Condition => '$$self{HasIJPEG}',
            Notes  => 'InfiRay IR+thermal+visible data',
            Groups => { 0 => 'APP3', 1 => 'InfiRay', 2 => 'Image' },
            Binary => 1,
        },
        {
            Name => 'PreviewImage', Condition =>
              '$$valPt =~ /^\xff\xd8\xff\xdb/',
    ...
    APP4 => [
        ...
        {
            Name => 'FPXR', Condition => '$$valPt =~ /^FPXR\0/',
            SubDirectory => { TagTable => 'Image::ExifTool::FlashPix::Main' },
        },
        {
...
'$$self{Make} eq "DJI" and $$valPt =~ /^(.{32})?.{32}\x2c\x01\x20\0/s',
    ...
    APP5 => [
        ...
        {
            Name => 'ThermalCalibration', Condition => '$$self{Make} eq "DJI"',
            Notes  => 'DJI thermal calibration data',
            Groups => { 0 => 'APP5', 1 => 'DJI', 2 => 'Image' },
            Binary => 1,
        },
        {
            Name => 'PreviewImage', Notes => 'continued from APP4',
        }
    ],
    APP6 => [
        {
        ...
        {
            Name => 'HP_TDHD', Condition => '$$valPt =~ /^TDHD\x01\0\0\0/',
        ...
        {
            Name => 'DJI_DTAT', Condition => '$$valPt =~ /^DTAT\0\0.\{/s',
            Groups => { 0 => 'APP6', 1 => 'DJI' },
    ...
    APP10 => [
        ...
        {
            Name => 'HDRGainInfo', Condition => '$$valPt =~ /^AROT\0\0.{4}/s',
            SubDirectory =>
    ...
    APP14 => {
        ...
        Writable  => 2, SubDirectory =>
          { TagTable => 'Image::ExifTool::JPEG::Adobe' },
    },
    APP15 => {
...
%Image::ExifTool::JPEG::HDRGainInfo = (
    ...
    10 => {
        Name   => 'HDRGainCurve', Format => 'int32uRev[$val{6}]',
        Binary => 1,
    },
);
...
%Image::ExifTool::JPEG::JPS = (
    ...
    0x0a         => {
        Name    => 'JPSSeparation',
        Format  => 'int32u', Notes => 'stereo only',
        RawConv => q{
    ...
    0x0d => {
        Name => 'JPSType',
        Hook => '$varSize += $$self{HdrLength} - 4', PrintConv =>
          { 0 => 'Mono', 1 => 'Stereo' },
    },
    0x10 => {
        Name   => 'JPSComment',
...
%Image::ExifTool::JPEG::Adobe = (
    ...
    1      => {
        ...
        PrintConv => {
            0       => '(none)',
            BITMASK => { 15 => 'Encoded with Blend=1 downsampling' },
        },
    },
    2 => {
        Name      => 'APP14Flags1',
