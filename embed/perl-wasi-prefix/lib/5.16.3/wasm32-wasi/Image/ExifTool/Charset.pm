...
%csType = (
    ...
    Turkish      => 0x101,
    Vietnam      => 0x101,
    MacArabic    => 0x103, PDFDoc => 0x181,
    Unicode      => 0x200, UCS2 => 0x200,
    UTF16        => 0x200, Symbol => 0x201,
    JIS          => 0x201,
    UCS4         => 0x400, MacChineseCN => 0x803,
    MacChineseTW => 0x803,
    MacHebrew    => 0x803, MacKorean => 0x803,
    MacRSymbol   => 0x803,
    MacThai      => 0x803,
    MacJapanese  => 0x883,
    ShiftJIS     => 0x883,
...
sub Decompose($$$;$) {
    ...
    if ( $type & 0x100 ) { @uni = unpack( 'C*', $val );
        foreach (@uni) {
            $_ = $$conv{$_} if defined $$conv{$_};
        }
    }
    elsif ( $type & 0x600 ) { my $unknown;
        my $byteOrder = $_[3];
        if ( not $byteOrder ) {
