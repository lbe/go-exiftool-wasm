...
%nsURI = (
    ...
    cc    => 'http://creativecommons.org/ns#', crd =>
    ...
    MP1             => 'http://ns.microsoft.com/photo/1.1', MP =>
    ...
    prism       => 'http://prismstandard.org/namespaces/basic/2.0/', prl =>
...
my %recognizedAttrs = (
    ...
    'rdf:nodeID'    => 1,
    'et:toolkit'    => 1,
    'rdf:xmlns' => 1, 'lastUpdate' =>
      [ 'Image::ExifTool::XMP::XML', 'lastUpdate', 'LastUpdate' ], );

%specialStruct = (
    STRUCT_NAME => 1, NAMESPACE => 1, NOTES => 1, TYPE => 1,  GROUPS =>
      1, SORT_ORDER => 1, );
my %sResourceRef = (
...
my %sPageInfo = (
    ...
    NAMESPACE   => 'xmpGImg',
    PageNumber  => { Writable => 'integer', Namespace => 'xmpTPg' }, height =>
      { Writable => 'integer' },
    width    => { Writable => 'integer' },
    'format' => {},
    image    => {
...
%Image::ExifTool::XMP::Main = (
    ...
    WRITE_PROC   => \&WriteXMP,
    dc           => {
        Name => 'dc', SubDirectory =>
          { TagTable => 'Image::ExifTool::XMP::dc' },
    },
    xmp => {
        Name         => 'xmp',
...
%Image::ExifTool::XMP::xmp = (
    ...
    , Keywords => { Avoid => 1, Notes => 'non-standard' }, Description =>
...
%Image::ExifTool::XMP::xmpMM = (
    ...
    InstanceID  => {}, ManagedFrom => { Struct => \%sResourceRef },
    ...
    PreservedFileName => {}, RenditionClass => {},
    RenditionParams   => {},
    VersionID         => {},
    Versions => { Struct => \%sVersion, List => 'Seq' },
    LastURL => {}, RenditionOf => { Struct => \%sResourceRef }, SaveID =>
      { Writable => 'integer' }, subject =>
...
%Image::ExifTool::XMP::pdf = (
    ...
    Author => { Groups => { 2 => 'Author' } }, ModDate =>
      { Groups => { 2 => 'Time' }, %dateTimeInfo }, CreationDate =>
      { Groups => { 2 => 'Time' }, %dateTimeInfo }, Creator =>
      { Groups => { 2 => 'Author' }, Avoid => 1 },
    Copyright => { Groups => { 2 => 'Author' }, Avoid => 1 }, Marked =>
      { Avoid => 1, Writable => 'boolean' }, Subject => { Avoid => 1 },
    Title   => { Avoid      => 1 },
    Trapped => {  ValueConv => '$val=~s{^/}{}; $val',
        ValueConvInv => '"/$val"',
        PrintConv => { True => 'True', False => 'False', Unknown => 'Unknown' },
    },
    Keywords => { Priority => -1 }, PDFVersion => {},
...
%Image::ExifTool::XMP::photoshop = (
    ...
    ColorMode       => {
        Writable  => 'integer', PrintConvColumns => 2,
        PrintConv => {
            0 => 'Bitmap',
            1 => 'Grayscale',
            2 => 'Indexed',
    ...
    DocumentAncestors => { List => 'Bag', },
    Headline          => {},
    History => {}, ICCProfile => { Name => 'ICCProfileName' }, Instructions =>
      {},
    LegacyIPTCDigest => {}, SidecarForExtension => {}, Source =>
      { Groups => { 2 => 'Author' } },
    ...
    Urgency               => {
        ...
        PrintConv => { 0 => '0 (reserved)', 1 => '1 (most urgent)',
            2 => 2,
            3 => 3,
            4 => 4,
            5 => '5 (normal urgency)',
    ...
    EmbeddedXMPDigest => {}, CameraProfiles => { List => 'Seq',
        Struct => {
            NAMESPACE          => 'stCamera',
            STRUCT_NAME        => 'Camera',
            Author             => {},
...
%Image::ExifTool::XMP::crs = (
    ...
    AlreadyApplied => { Writable => 'boolean' }, AutoBrightness =>
      { Writable => 'boolean' },
    ...
    Converter => {}, CropTop => { Writable => 'real' },
    ...
    PostCropVignetteStyle     => {
        Writable  => 'integer',
        PrintConv => { 1 => 'Highlight Priority',
            2 => 'Color Priority',
            3 => 'Paint Overlay', },
    },
    ...
    Highlight2012 => { Writable => 'integer' }, Shadows2012 =>
      { Writable => 'integer' },
    ...
    PerspectiveUpright            => {
        Writable  => 'integer',
        PrintConv => { 0 => 'Off', 1 => 'Auto', 2 => 'Full', 3 => 'Level', 4 =>
              'Vertical', 5 => 'Guided', },
    },
    RetouchAreas => {
    ...
    What                               => {}, LensProfileMatchKeyExifMake => {},
    ...
    LookName => { NotFlat => 1 },  ColorGradeMidtoneHue =>
      { Writable => 'integer' },
    ...
    LensBlur      => {
        Struct => {
            ...
            FocalRange => {}, FocalRangeSource => { Writable => 'real' },
            HighlightsBoost     => { Writable => 'real' },
            HighlightsThreshold => { Writable => 'real' },
            SampledArea => {}, SampledRange => {}, SphericalAberration =>
              { Writable => 'real' },
            SubjectRange => {}, Version => {},
        },
    },
    DepthMapInfo => {
        Struct => {
...
%Image::ExifTool::XMP::tiff = (
    ...
    NAMESPACE => 'tiff',
    PRIORITY => 0, TABLE_DESC => 'XMP TIFF',
    NOTES    => q{
    ...
    ReferenceBlackWhite =>
      { Writable => 'rational', List => 'Seq', AutoSplit => 1 },
    DateTime => { Description => 'Date/Time Modified',
        Groups => { 2 => 'Time' },
        %dateTimeInfo,
    },
...
%Image::ExifTool::XMP::exif = (
    ...
    DateTimeDigitized => { Description => 'Date/Time Digitized',
        Groups => { 2 => 'Time' },
        %dateTimeInfo,
    },
    ExposureTime => {
    ...
    SensingMethod => {
        ...
        PrintConv => {
            ...
            6 => 'Monochrome linear', 7 => 'Trilinear',
    ...
    GPSHPositioningError => { Description => 'GPS Horizontal Positioning Error',
        Groups       => { 2 => 'Location' },
        Writable     => 'rational',
        PrintConv    => '"$val m"',
        PrintConvInv => '$val=~s/\s*m$//; $val', },
...
'Standard Output Sensitivity, Recommended Exposure Index and ISO Speed',
    ...
    LensSpecification => {
        ...
        Groups       => { 2 => 'Camera' },
        List         => 'Seq',
        RawJoin      => 1, ValueConv => \&ConvertRationalList,
        ValueConvInv => sub {
            my $val = shift;
            my @vals = split ' ', $val;
...
%Image::ExifTool::XMP::aux = (
    ...
    Firmware => {}, FlashCompensation => { Writable => 'rational' }
    , ImageNumber => {}, LensInfo =>
      { Notes => '4 rational values giving focal and aperture ranges',
        ...
        PrintConvInv => \&Image::ExifTool::Exif::ConvertLensInfo, },
    Lens      => {},
    OwnerName => { Avoid => 1 }, SerialNumber => { Avoid => 1 },
    ...
    LateralChromaticAberrationCorrectionAlreadyApplied =>
      { Writable => 'boolean' },
    LensDistortInfo => {}, NeutralDensityFactor => {}
    ,  EnhanceDetailsAlreadyApplied => { Writable => 'boolean' },
    EnhanceDetailsVersion => {}, EnhanceSuperResolutionAlreadyApplied =>
      { Writable => 'boolean' },
    EnhanceSuperResolutionVersion => {}, EnhanceSuperResolutionScale =>
      { Writable => 'rational' },
    EnhanceDenoiseAlreadyApplied => { Writable => 'boolean' }
    , EnhanceDenoiseVersion => {}, EnhanceDenoiseLumaAmount => {}
...
sub AddFlattenedTags($;$$$) {
    ...
    foreach $tagID (@tagIDs) {
        ...
        unless ( ref $strTable ) { my $strName = $strTable;
        ...
        foreach $field ( keys %$strTable ) {
            ...
            $count +=
              AddFlattenedTags( $tagTablePtr, $flatID,
...
qq(Boolean value for XMP-$ns:$$tagInfo{Name} should be "True" or "False"),
    ...
    if ( $$tagInfo{SubDirectory} and not $$et{IsWriting} ) {
        ...
        my %dirInfo = (
            ...
            TagInfo => $tagInfo,
            IgnoreProp => $$subdir{IgnoreProp}, IsExtended => 1, NoStruct =>
              1, NoBlockSave => 1, );
...
"Extracted only 1000 $ns:$tg items. Ignore minor errors to extract all",
        ...
        elsif ( $$et{XmpIgnoreProps} ) { foreach ( @{ $$et{XmpIgnoreProps} } ) {
