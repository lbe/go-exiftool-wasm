...
%knownProtocol = (
    'dvtm_ac203.proto' => 1, 'dvtm_ac204.proto' => 1, 'dvtm_ac206.proto' =>
      1, 'dvtm_AVATA2.proto'  => 1, 'dvtm_wm265e.proto' =>
      1, 'dvtm_pm320.proto'   => 1, 'dvtm_Mini4_Pro.proto' =>
      1, 'dvtm_dji_neo.proto' => 1, 'dvtm_Air3.proto' =>
      1, 'dvtm_Air3s.proto'   => 1, 'dvtm_PP-101.proto' =>
      1, 'dvtm_oq101.proto'   => 1, 'dvtm_wa345e.proto' =>
      1, 'dvtm_wm261.proto'   => 1, 'dvtm_Mavic4.proto' =>
      1, 'dvtm_Mini5Pro.proto' => 1, );
...
%Image::ExifTool::DJI::Main = (
    ...
    0x03 => { Name => 'SpeedX', Writable => 'float', %convFloat2 }, 0x04 =>
      { Name => 'SpeedY', Writable => 'float', %convFloat2 }, 0x05 =>
      { Name => 'SpeedZ', Writable => 'float', %convFloat2 }, 0x06 =>
      { Name => 'Pitch',  Writable => 'float', %convFloat2 },
...
'Thermal parameters extracted from APP4 of DJI RJPEG files from the ZH20T.',
    ...
    0x4c => { Name => 'AmbientTemperature', Format => 'int16u' }, 0x50 =>
      { Name => 'D2', Format => 'int32s' },
...
%Image::ExifTool::DJI::ThermalParams2 = (
    ...
    0x65 => { Name => 'IDString', Format => 'string[16]' }, );
...
%Image::ExifTool::DJI::ThermalParams3 = (
    ...
    0x08 =>
      { Name => 'Emissivity', Format => 'int16u', ValueConv => '$val / 100' },
    0x0a => {
        Name      => 'ReflectedTemperature',
        Format    => 'int16u',
        ValueConv => '$val / 10'
...
%Image::ExifTool::DJI::XMP = (
    ...
    GpsLongtitude => { Name => 'GPSLongtitude',
        Writable => 'real',
        Avoid    => 1, PrintConv =>
...
%Image::ExifTool::DJI::Protobuf = (
    ...
    'dvtm_ac203_1-1-5' => { Name => 'SerialNumber', Notes => 'Osmo Action 4' }
    ...
    'dvtm_ac203_3-2-4-1' => { Name => 'ShutterSpeed',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintExposureTime($val)', },
    'dvtm_ac203_3-2-6-1' => { Name => 'ColorTemperature', Format => 'unsigned' }
    ,  'dvtm_ac203_3-2-10-2' => { Name => 'AccelerometerX', Format => 'float' }
    , 'dvtm_ac203_3-2-10-3'  => { Name => 'AccelerometerY', Format => 'float' }
    , 'dvtm_ac203_3-2-10-4'  => { Name => 'AccelerometerZ', Format => 'float' }
    ,  'dvtm_ac203_3-4-2-1'  => {
        Name         => 'GPSInfo',
    ...
    'dvtm_ac204_1-1-5' => { Name => 'SerialNumber', Notes => 'Osmo Action 5' }
    ,  'dvtm_ac204_1-1-10' => 'Model',
    'dvtm_ac204_2-3' => {
        Name         => 'FrameInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::FrameInfo' },
    },
    'dvtm_ac204_3-2-4-1' => { Name => 'ShutterSpeed',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintExposureTime($val)', },
    'dvtm_ac204_3-2-6-1' => { Name => 'ColorTemperature', Format => 'unsigned' }
    , 'dvtm_ac204_3-2-10-2' => { Name => 'AccelerometerX', Format => 'float' }
    , 'dvtm_ac204_3-2-10-3' => { Name => 'AccelerometerY', Format => 'float' }
    , 'dvtm_ac204_3-2-10-4' => { Name => 'AccelerometerZ', Format => 'float' }
    ,  'dvtm_ac204_3-4-2-1' => {
        Name         => 'GPSInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::GPSInfo' },
    },
    ...
    'dvtm_ac206_1-1-5' => { Name => 'SerialNumber', Notes => 'Osmo Action 6' }
    ,  'dvtm_ac206_1-1-10' => 'Model',
    'dvtm_ac206_2-3' => {
        Name         => 'FrameInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::FrameInfo' },
    },
    'dvtm_ac206_3-2-4-1' => { Name => 'ShutterSpeed',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintExposureTime($val)', },
    'dvtm_ac206_3-2-6-1' => { Name => 'ColorTemperature', Format => 'unsigned' }
    , 'dvtm_ac206_3-2-10-2' => { Name => 'AccelerometerX', Format => 'float' }
    , 'dvtm_ac206_3-2-10-3' => { Name => 'AccelerometerY', Format => 'float' }
    , 'dvtm_ac206_3-2-10-4' => { Name => 'AccelerometerZ', Format => 'float' }
    ,  'dvtm_ac206_3-4-2-1' => {
        Name         => 'GPSInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::GPSInfo' },
    },
    ...
    'dvtm_AVATA2_1-1-5' => { Name => 'SerialNumber', Notes => 'Avata 2' }
    , 'dvtm_AVATA2_1-1-10' => 'Model',
    'dvtm_AVATA2_2-2-3-1' => 'SerialNumber2', 'dvtm_AVATA2_2-3' => {
        Name         => 'FrameInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::FrameInfo' },
    },
    'dvtm_AVATA2_3-1-2' => { Name => 'TimeStamp',
        Groups    => { 2 => 'Time' },
        Format    => 'unsigned',
        ValueConv => '$val / 1e6', },
    'dvtm_AVATA2_3-2-2-1' => { Name => 'ISO', Format => 'float' }
    , 'dvtm_AVATA2_3-2-4-1' => {
        Name      => 'ShutterSpeed',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintExposureTime($val)',
    ...
    'dvtm_AVATA2_3-2-6-1' =>
      { Name => 'ColorTemperature', Format => 'unsigned' }
    , 'dvtm_AVATA2_3-2-10-1' => { Name => 'FNumber',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintFNumber($val)', },
    'dvtm_AVATA2_3-4-3' => { Name => 'DroneInfo',
    ...
    'dvtm_AVATA2_3-4-4-2' => {
        ...
        Format    => 'float',
        ValueConv => '$val / 1000'
      }, 'dvtm_wm265e_1-1-5' => { Name => 'SerialNumber', Notes => 'Mavic 3' }
    ...
    'dvtm_pm320_3-2-4-1' => { Name => 'FNumber',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintFNumber($val)', },
    ...
    'dvtm_Mini4_Pro_3-2-32-1' =>
      { Name => 'ColorTemperature', Format => 'unsigned' },
    'dvtm_Mini4_Pro_3-2-37-1' => { Name => 'Temperature', Format => 'float' }
    ...
    'dvtm_dji_neo_1-1-5' => { Name => 'SerialNumber', Notes => 'DJI Neo' }
    , 'dvtm_dji_neo_1-1-10' => 'Model',
    'dvtm_dji_neo_2-2-3-1' => 'SerialNumber2', 'dvtm_dji_neo_2-3' => {
        Name         => 'FrameInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::FrameInfo' },
    },
    'dvtm_dji_neo_3-1-2' => { Name => 'TimeStamp',
        Groups    => { 2 => 'Time' },
        Format    => 'unsigned',
        ValueConv => '$val / 1e6', },
    'dvtm_dji_neo_3-2-2-1' => { Name => 'ISO', Format => 'float' }
    ...
    'dvtm_dji_neo_3-2-6-1' =>
      { Name => 'ColorTemperature', Format => 'unsigned' }
    , 'dvtm_dji_neo_3-2-10-1' => { Name => 'FNumber',
        Format    => 'rational',
        PrintConv => 'Image::ExifTool::Exif::PrintFNumber($val)', },
    'dvtm_dji_neo_3-4-3' => { Name => 'DroneInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::DroneInfo' }, },
    ...
    'dvtm_Mavic4_3-2-24-1' =>
      { Name => 'ColorTemperature', Format => 'unsigned' },
    'dvtm_Mavic4_3-2-37-1' => { Name => 'Temperature', Format => 'float' }
    , 'dvtm_Mavic4_3-3-3' => { Name => 'DroneInfo',
        SubDirectory => { TagTable => 'Image::ExifTool::DJI::DroneInfo' }, },
    'dvtm_Mavic4_3-3-4-1' => {
        Name      => 'GPSInfo',
        Condition => '$$self{CoordUnits} = 1', SubDirectory =>
          { TagTable => 'Image::ExifTool::DJI::GPSInfo' },
    },
    'dvtm_Mavic4_3-3-4-2' => {
        Name      => 'AbsoluteAltitude',
        Format    => 'int64s',
      ...
      { Name => 'SerialNumber', Notes => 'Mini 5 Pro' }
    , 'dvtm_Mini5Pro_1-1-10' => 'Model', 'dvtm_Mini5Pro_3-2-37-1' =>
      { Name => 'Temperature', Format => 'float' }, 'dvtm_Mini5Pro_3-3-4-1' => {
        Name      => 'GPSInfo',
        Condition => '$$self{CoordUnits} = 1', SubDirectory =>
          { TagTable => 'Image::ExifTool::DJI::GPSInfo' },
      },
    'dvtm_Mini5Pro_3-3-4-2' => {
        Name      => 'AbsoluteAltitude',
        Format    => 'int64s',
        ValueConv => '$val / 1000'
    }, );
...
%Image::ExifTool::DJI::GimbalInfo = (
    ...
    VARS         => { ID_FMT => 'dec', ID_LABEL => 'Field #' },
    1 =>
      { Name => 'GimbalPitch', Format => 'int64s', ValueConv => '$val / 10' },
    2 => { Name => 'GimbalRoll', Format => 'int64s', ValueConv => '$val / 10' }
    , 3 =>
      { Name => 'GimbalYaw', Format => 'int64s', ValueConv => '$val / 10' },
);
...
'not extracted, but used internally to convert coordinates to degrees',
    ...
    2 => {
        ...
        Format => 'double',
        RawConv =>
'$$self{GPSLatitude} = $$self{CoordUnits} ? $val : $val * 180 / 3.141592653589793'
        , PrintConv => 'Image::ExifTool::GPS::ToDMS($self, $val, 1, "N")',
    },
    3 => {
        Name   => 'GPSLongitude',
        Format => 'double',
        RawConv =>
'$$self{GPSLongitude} = $$self{CoordUnits} ? $val : $val * 180 / 3.141592653589793'
        , PrintConv => 'Image::ExifTool::GPS::ToDMS($self, $val, 1, "E")',
    },
);
...
sub ProcessSettings($$$) {
    ...
    $et->VerboseDir( $$dirInfo{DirName}, undef,
        length( ${ $$dirInfo{DataPt} } ) );
