...
%Image::ExifTool::Casio::Main = (
    ...
    0x0001     => {
        ...
        PrintConv => {
            ...
            4 => 'Portrait',
            5 => 'Landscape',
            7 => 'Panorama', 10 => 'Night Scene', 15 => 'Portrait', 16 =>
              'Landscape', },
    },
    0x0002 => {
        Name      => 'Quality',
    ...
    0x000a => {
        ...
        PrintConv => {
            0x10000 => 'Off',
            0x10001 => '2x',
            0x19999 => '1.6x', 0x20000 => '2x', 0x33333 => '3.2x', 0x40000 =>
              '4x', },
    },
    0x000b => {
        Name      => 'Sharpness',
    ...
    0x0015 => { Name => 'FirmwareDate',
        Writable  => 'string',
        Format    => 'undef', Count => 18,
        PrintConv => q{
            $_ = $val;
    ...
    0x0018 => { Name => 'AFPoint',
        Writable => 'int16u',
        Notes    => 'may not be valid for all models', PrintConv => {
            1  => 'Center',
            2  => 'Upper Left',
            3  => 'Upper Right',
...
%Image::ExifTool::Casio::Type2 = (
    ...
    0x0004 => {
        ...
        Groups     => { 2 => 'Image' },
        Flags      => 'IsOffset',
        OffsetPair => 0x0003, DataTag => 'PreviewImage',
        Writable   => 'int32u',
        WriteGroup => 'MakerNotes',
        Protected  => 2,
    },
    ...
    0x2012 => {
        ...
        PrintConv => {
            0 => 'Manual',
            1 => 'Daylight', 2 => 'Cloudy', 3 => 'Shade', 4 => 'Flash?',
            6 => 'Fluorescent', 9 => 'Tungsten?', 10 => 'Tungsten', 12 =>
              'Flash',
        },
    },
    0x2021 => { Name => 'AFPointPosition',
        Writable  => 'int16u',
        Count     => 4,
        PrintConv => q{
            my @v = split ' ', $val;
    ...
    0x2089 => [ {
            Name => 'FaceInfo1',
            Condition =>
              '$$valPt =~ /^(\0\0|.\x02\x80\x01\xe0)/s', SubDirectory => {
        ...
        {
            Name      => 'FaceInfo2',
            Condition => '$$valPt =~ /^\x02\x01/', SubDirectory => {
    ...
    0x211c => { Name => 'FacesDetected',
        Format => 'int8u', },
    0x3000 => {
        Name      => 'RecordMode',
        Writable  => 'int16u',
        PrintConv => {
            2 => 'Program AE', 3 => 'Shutter Priority', 4 =>
              'Aperture Priority', 5 => 'Manual', 6 => 'Best Shot', 17 =>
              'Movie', 19 => 'Movie (19)', 20 => 'YouTube Movie', '2 0' =>
              'Program AE', '3 0' => 'Shutter Priority', '4 0' =>
              'Aperture Priority', '5 0' => 'Manual', '6 0' => 'Best Shot', },
    },
    0x3001 => { Name => 'ReleaseMode',
        Writable  => 'int16u',
        PrintConv => {
            1  => 'Normal',
            3  => 'AE Bracketing',
    ...
    0x3003 => {
        ...
        Writable  => 'int16u',
        PrintConv => {
            0 => 'Manual', 1 => 'Focus Lock', 2 => 'Macro', 3 =>
              'Single-Area Auto Focus',
            5 => 'Infinity', 6 => 'Multi-Area Auto Focus',
            8 => 'Super Macro', },
    },
    0x3006 => {
        Name     => 'HometownCity',
    ...
    0x3007 => [
        ...
        },
        {
            ...
            PrintConv        => {
                ...
                11 => 'Natural Green',
                12 => 'Autumn Leaves',
                13 => 'Soft Flowing Water', 14 => 'Splashing Water',
                15 => 'Sundown',
                16 => 'Night Scene',
        ...
        },
        {
            ...
            Writable => 'int16u',
            Condition =>
              '$$self{Model} eq "EX-Z750" and $$self{FILE_TYPE} eq "JPEG"',
        ...
        },
        {
            ...
            Writable => 'int16u',
            Condition =>
'$$self{Model} eq "EX-Z750" and $$self{FILE_TYPE} =~ /^(MOV|AVI)$/',
        ...
        },
        {
            ...
            Writable => 'int16u',
            Condition =>
              '$$self{Model} eq "EX-Z850" and $$self{FILE_TYPE} eq "JPEG"',
        ...
        },
        {
            ...
            Writable => 'int16u',
            Condition =>
'$$self{Model} eq "EX-Z850" and $$self{FILE_TYPE} =~ /^(MOV|AVI)$/',
        ...
        },
        {
            ...
            Writable => 'int16u',
            Condition =>
              '$$self{Model} eq "EX-Z1200" and $$self{FILE_TYPE} eq "JPEG"',
        ...
        },
        {
            ...
            Writable => 'int16u',
            Condition =>
'$$self{Model} eq "EX-Z1200" and $$self{FILE_TYPE} =~ /^(MOV|AVI)$/',
    ...
    0x3008 => { Name => 'AutoISO',
        ...
        PrintConv => {
            1 => 'On',
            2 => 'Off',
            7 => 'On (high sensitivity)', 8 => 'On (anti-shake)', 10 =>
              'High Speed', },
    },
    0x3009 => { Name => 'AFMode',
        Writable  => 'int16u',
        PrintConv => {
            ...
            2 => 'Multi',
            3 => 'Face Detection',
            4 => 'Tracking', 5 => 'Intelligent',
        },
    },
    0x3011 => { Name => 'Sharpness',
        Format   => 'int16s',
        Writable => 'undef', },
    0x3012 => { Name => 'Contrast',
        Format   => 'int16s',
        Writable => 'undef', },
    0x3013 => { Name => 'Saturation',
        Format   => 'int16s',
        Writable => 'undef', },
    0x3014 => {
        Name     => 'ISO',
    ...
    0x3016 => {
        ...
        PrintConv => {
            0 => 'Off',
            1 => 'Scenery', 3 => 'Green', 5 => 'Underwater', 9 =>
              'Flesh Tones', },
    },
    0x3017 => {
        Name      => 'ColorFilter',
        ...
        PrintConv => {
            0 => 'Off',
            1 => 'Blue', 3 => 'Green', 4 => 'Yellow', 5 => 'Red', 6 =>
              'Purple', 7 => 'Pink', },
    },
    0x301b => { Name => 'ArtMode',
        Writable  => 'int16u',
        PrintConv => {
            0  => 'Normal',
            8  => 'Silent Movie',
            39 => 'HDR', 45 => 'Premium Auto', 47 => 'Painting', 49 =>
              'Crayon Drawing', 51 => 'Panorama', 52 => 'Art HDR', 62 =>
              'High Speed Night Shot', 64 => 'Monochrome', 67 =>
              'Toy Camera', 68 => 'Pop Art', 69 => 'Light Tone', },
    },
    0x301c => { Name => 'SequenceNumber', Writable => 'int16u', },
    0x301d => { Name => 'BracketSequence',
        Writable => 'int16u',
        Count    => 2, },
    0x3020 => { Name => 'ImageStabilization',
        Writable  => 'int16u',
        PrintConv => {
            0 => 'Off',
            1 => 'On',
            2 => 'Best Shot',
            3 => 'Movie Anti-Shake',  '0 0' => 'Off', '16 0' =>
              'Slow Shutter',     '18 0' => 'Anti-Shake',       '20 0' =>
              'High Sensitivity',  '0 1' => 'Off (1)',          '0 3' =>
              'CCD Shift',        '2 1'  => 'High Sensitivity', '2 3' =>
              'CCD Shift + High Sensitivity',    },
    },
    0x302a => { Name => 'LightingMode', Writable => 'int16u',
        PrintConv => {
            0 => 'Off',
            1 => 'High Dynamic Range', 5 => 'Shadow Enhance Low', 6 =>
              'Shadow Enhance High', },
    },
    0x302b => { Name => 'PortraitRefiner',
        Writable  => 'int16u',
        PrintConv => {
            0 => 'Off',
            1 => '+1',
    ...
    0x3030 => { Name => 'SpecialEffectLevel',
        Writable => 'int16u', },
    0x3031 => { Name => 'SpecialEffectSetting',
        Writable  => 'int16u',
        PrintConv => {
            0  => 'Off',
            1  => 'Makeup',
    ...
    0x3103 => { Name => 'DriveMode',
        ...
        PrintConv        => {
            ...
            0 => 'Single Shot', 1 => 'Continuous Shooting', 2 =>
              'Continuous (2 fps)',
            3   => 'Continuous (3 fps)',
            4   => 'Continuous (4 fps)',
            5   => 'Continuous (5 fps)',
            ...
            40  => 'Continuous (40 fps)', 60 => 'Continuous (60 fps)',
            240 => 'Auto-N',
        },
    },
    0x310b => { Name => 'ArtModeParameters',
        Writable => 'int8u',
        Count    => 3, },
    0x4001 => { Name => 'CaptureFrameRate',
        Writable  => 'int16u',
        Count     => -1,
        ValueConv => q{
            my @v=split(" ",$val);
    ...
    0x4003 => { Name => 'VideoQuality',
        Writable  => 'int16u',
        PrintConv => {
            1 => 'Standard',
            3 => 'HD (720p)',
            4 => 'Full HD (1080p)', 5 => 'Low', },
    },
);
