...
%Image::ExifTool::PSP::Main = (
    ...
    0           => [
        ...
        {
            Name         => 'ImageInfo',
            SubDirectory => { TagTable => 'Image::ExifTool::PSP::Image', },
        },
    ],
    1 => {
        Name         => 'CreatorInfo',
...
%Image::ExifTool::PSP::Creator = (
    ...
    7 => {
        ...
        Format    => 'int8u',
        Count     => 4,
        ValueConv => 'join(" ",reverse split " ", $val)', PrintConv =>
          '$val=~tr/ /./; $val',
    },
);
...
sub ProcessExtData($$$) {
    ...
    while ( $pos + 10 < $dirLen ) {
        ...
        my %dirInfo = (
            ...
            Parent   => 'PSP',
            DataPt   => $dataPt,
            DataPos  => -$start, DataLen => length $$dataPt,
            DirStart => $start,
            Base     => $start + $$dirInfo{DataPos}, Multi => 0,
        );
