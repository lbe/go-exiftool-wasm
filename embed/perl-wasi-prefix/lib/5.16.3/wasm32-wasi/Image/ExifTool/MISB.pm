...
%Image::ExifTool::MISB::Main = (
    ...
    '060e2b3402030101434e415644494147' => { Name => 'ChurchillNav',
        SubDirectory => {
            TagTable  => 'Image::ExifTool::MISB::ChurchillNav',
            ByteOrder => 'LittleEndian', },
    },
    '060E2B34030101010E01030302000000' => { Name => 'Security',
...
%Image::ExifTool::MISB::UASDatalink = (
    ...
    5 => {
        Name      => 'GPSTrack',
        Format    => 'int16u',
        ValueConv => '$val * 360 / 0xffff'
    },
    6 => {
        Name      => 'PitchAngle',
        Format    => 'int16s',
        ValueConv => '$val * 20 / 0x7fff'
    },
    7 => {
        Name      => 'RollAngle',
        Format    => 'int16s',
        ValueConv => '$val * 50 / 0x7fff'
    },
    8 =>
      { Name => 'TrueAirspeed', Format => 'int8u', PrintConv => '"$val m/s"' },
    9 => {
    ...
    21 => {
        Name      => 'SlantRange',
        Format    => 'int32u',
        ValueConv => '$val * 5000000 / 0xffffffff'
    },
    22 => {
        Name      => 'TargetWidth',
        Format    => 'int16u',
        ValueConv => '$val * 10000 / 0xffff'
    },
    23 => { Name => 'FrameCenterLatitude',  %latInfo },
    24 => { Name => 'FrameCenterLongitude', %lonInfo },
    25 => { Name => 'FrameCenterElevation', %altInfo },
    26 => {
        Name      => 'OffsetCornerLatitude1',
        Format    => 'int16s',
        ValueConv => '$val * .075 / 0x7fff'
    },
    27 => {
        Name      => 'OffsetCornerLongitude1',
        Format    => 'int16s',
        ValueConv => '$val * .075 / 0x7fff'
    },
    28 => {
    ...
    36 => {
        Name      => 'WindSpeed',
        Format    => 'int8u',
        ValueConv => '$val * 100 / 0xff',
        Notes     => 'm/s'
    },
    37 => {
        Name      => 'StaticPressure',
        Format    => 'int16u',
        ValueConv => '$val * 5000 / 0xffff',
        Notes     => 'mbar'
    },
    38 => {
    ...
    66 => {
        Name      => 'TargetLocationCovarianceMatrix',
        Format    => 'undef',
        ValueConv => '\$val'
    },
    ...
    79 => {
        Name      => 'SensorVelocityNorth',
        Format    => 'int16s',
        ValueConv => '$val * 327 / 0x7fff'
    },
    80 => {
        Name      => 'SensorVelocityEast',
        Format    => 'int16s',
        ValueConv => '$val * 327 / 0x7fff'
    },
    81 => {
    ...
    92 => {
        Name      => 'FullAngleOfAttack',
        Format    => 'int32s',
        ValueConv => '$val * 90 / 0x7fffffff'
    },
    93 => {
        Name      => 'FullSideslipAngle',
        Format    => 'int32s',
        ValueConv => '$val * 90 / 0x7fffffff'
    },
    94 =>
      { Name => 'MIISCoreIdentifier', Format => 'undef', ValueConv => '\$val' },
    95 => {
        Name         => 'SARMotionImageryData',
        SubDirectory => { TagTable => 'Image::ExifTool::MISB::Unknown' }
    },
    96 => {
    ...
    102 => { Name => 'SDCC-FLP', Format => 'undef', ValueConv => '\$val' }
    , 103 => {
        ...
        Name      => 'AlternateEllipsoidHeightExtended',
        Format    => 'undef',
        ValueConv => '\$val'
      }, );
...
%Image::ExifTool::MISB::Security = (
    ...
    2 => {
        Name      => 'ClassifyingCountryCodeMethod',
        PrintConv => {
...
%Image::ExifTool::MISB::ChurchillNav = (
    ...
    1 => {
        Name    => 'ChurchillNav_0x0001',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    2 => {
        Name    => 'ChurchillNav_0x0002',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    3 => {
        Name    => 'ChurchillNav_0x0003',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    4 => {
        Name    => 'ChurchillNav_0x0004',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    5 => {
        Name    => 'ChurchillNav_0x0005',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    6 => {
        Name    => 'ChurchillNav_0x0006',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    9 => {
        Name    => 'ChurchillNav_0x0009',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    10 => {
        Name    => 'ChurchillNav_0x000a',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    11 => {
        Name    => 'ChurchillNav_0x000b',
        Format  => 'string',
        Unknown => 1,
        Hidden  => 1
    },
    12 => {
        Name    => 'ChurchillNav_0x000c',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    13 => {
        Name    => 'ChurchillNav_0x000d',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    14 => {
        Name    => 'ChurchillNav_0x000e',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    16 => {
        Name    => 'ChurchillNav_0x0010',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    17 => {
        Name    => 'ChurchillNav_0x0011',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    18 => {
        Name    => 'ChurchillNav_0x0012',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
    20 => {
        Name    => 'ChurchillNav_0x0014',
        Format  => 'double',
        Unknown => 1,
        Hidden  => 1
    },
...
sub ParseMISB($$$) {
    ...
    for ( $pos = 5 ; $pos + 16 < $end ; ) {
        ...
        unless ($tagInfo) {
            if ( $verbose or $unknown ) {
                $tagInfo = {
                    Name => "MISB_$key",
                    SubDirectory =>
                      { TagTable => 'Image::ExifTool::MISB::Unknown' }
                };
        ...
        if ( $pos + $len > $end ) {
            $len = $end - $pos;
            $et->VPrint( 0,
                "$$et{INDENT}(truncated record, only $len bytes available)\n" );
        }
        ...
        ProcessKLV( $et, \%dirInfo, GetTagTable( $$dir{TagTable} ) )
          and $rtnVal = 1;
        SetByteOrder('MM');
        $pos += $len;
    }
