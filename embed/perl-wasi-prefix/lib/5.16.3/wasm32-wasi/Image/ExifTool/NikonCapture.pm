...
%Image::ExifTool::NikonCapture::WBAdjData = (
    ...
    0x10 => {
        ...
        PrintConv => {
            ...
            5 => 'Auto2', 6 => 'Underwater', 7 => 'Auto1',
        },
    },
    0x14 => { Name => 'WBAdjLighting',
        Format    => 'int16u',
        PrintHex  => 1,
        PrintConv => {
            0x000 => 'None',
...
%Image::ExifTool::NikonCapture::PictureCtrl = (
    ...
    0x2d => {
        Name      => 'BrightnessAdj',
        ValueConv => '$val ? $val - 128 : "Auto"', ValueConvInv =>
          '$val=~/\d/ ? $val + 128 : 0',
    },
    0x2e => {
        Name         => 'SaturationAdj',
    ...
    for ( $pos = $dirStart + 22 ; $pos + 22 < $dirEnd ; $pos += 22 + $size ) {
        ...
        if ($tagInfo) {
            ...
            if ( $$tagInfo{SubDirectory} ) {
                ...
                $$tagInfo{Name} =~ /IPTC/
                  and $et->Options( IgnoreMinorErrors => 1 );
                ...
                if ( $et->IsOverwriting( $nvHash, $oldVal ) ) {
                    ...
                    $newVal = WriteValue( $val, $$tagInfo{Writable} )
                      if defined $val;
