...
use constant ONE_MONTH           => 2_629_744;
use constant ONE_REAL_MONTH      => '1M';
use constant ONE_YEAR            => 31_556_930;
use constant ONE_REAL_YEAR       => '1Y';
use constant ONE_FINANCIAL_MONTH => 2_592_000;
use constant LEAP_YEAR           => 31_622_400;
use constant NON_LEAP_YEAR       => 31_536_000;
