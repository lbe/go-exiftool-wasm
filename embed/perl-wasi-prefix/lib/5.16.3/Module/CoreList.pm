...
sub first_release_raw {
    my $module = shift;
    $module = shift
      if eval { $module->isa(__PACKAGE__) }
      and scalar @_
      and $_[0] =~ m#\A[a-zA-Z_][0-9a-zA-Z_]*(?:(::|')[0-9a-zA-Z_]+)*\z#;
    my $version = shift;

    my @perls =
      $version
      ? grep { exists $version{$_}{$module} && $version{$_}{$module} ge $version }
      keys %version
...
my %delta = (
    ...
    5.013003 => {
        ...
        removed => { 'TAP::Parser::Source::Perl' => 1, }
    },
    5.013004 => {
        delta_from => 5.013003,
        changed    => {
        ...
        removed => { 'TAP::Parser::SourceHandler::pgTAP' => 1, }
    },
    5.013005 => {
        delta_from => 5.013004,
        changed    => {
    ...
    5.013006 => {
        ...
        removed => { 'XS::APItest::KeywordRPN' => 1, }
    },
    5.013007 => {
        delta_from => 5.013006,
        changed    => {
    ...
    5.017 => {
        ...
        removed => { 'Version::Requirements' => 1, }
    },
    5.017001 => {
        delta_from => 5.017,
        changed    => {
...
%bug_tracker = (
    ...
    'Getopt::Long'          => undef,
    'HTTP::Tiny' =>
      'https://rt.cpan.org/Public/Dist/Display.html?Name=HTTP-Tiny',
    ...
    'Win32CORE'                              => undef,
    'XSLoader' =>
'https://rt.perl.org/rt3/Search/Results.html?Query=Queue=\'perl5\' AND Content LIKE \'module=XSLoader\' AND (Status=\'open\' OR Status=\'new\' OR Status=\'stalled\')',
