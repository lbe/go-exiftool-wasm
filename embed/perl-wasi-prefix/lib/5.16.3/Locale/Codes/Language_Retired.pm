...
$Locale::Codes::Retired{'language'}{'alpha-3'}{'name'} = {
    ...
    q(dutch, middle (ca.1050-1350)) =>
      [ q(dum), q(Dutch, Middle (ca.1050-1350)) ],
    ...
    q(english, middle (1100-1500)) =>
      [ q(enm), q(English, Middle (1100-1500)) ],
    q(ounge) => [ q(oue), q(Ounge) ],
    q(dumpu) => [ q(wtf), q(Dumpu) ],
    q(turkish, ottoman (1500-1928)) =>
      [ q(ota), q(Turkish, Ottoman (1500-1928)) ],
    q(kag-fer-jiir-koor-ror-us-zuksun) =>
      [ q(gel), q(Kag-Fer-Jiir-Koor-Ror-Us-Zuksun) ],
    q(creoles and pidgins, portuguese-based ) =>
      [ q(cpp), q(Creoles and pidgins, Portuguese-based ) ],
    ...
    q(south american indian (other)) =>
      [ q(sai), q(South American Indian (Other)) ],
    q(creoles and pidgins, english based) =>
      [ q(cpe), q(Creoles and pidgins, English based) ],
    q(basa) => [ q(bas), q(Basa) ],
    q(german, old high (ca.750-1050)) =>
      [ q(goh), q(German, Old High (ca.750-1050)) ],
    ...
    q(german, middle high (ca.1050-1500)) =>
      [ q(gmh), q(German, Middle High (ca.1050-1500)) ],
    q(french, middle (ca.1400-1600)) =>
      [ q(frm), q(French, Middle (ca.1400-1600)) ],
    ...
    q(persian, old (ca.600-400 b.c.)) =>
      [ q(peo), q(Persian, Old (ca.600-400 B.C.)) ],
