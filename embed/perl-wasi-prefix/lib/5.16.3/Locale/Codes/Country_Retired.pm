...
$Locale::Codes::Retired{'country'}{'dom'}{'name'} = {
    ...
    q(bonaire, saint eustatius and saba) =>
      [ q(BQ), q(Bonaire, Saint Eustatius and Saba) ],
...
$Locale::Codes::Retired{'country'}{'alpha-2'}{'name'} = {
    ...
    q(vatican city state (holy see)) =>
      [ q(va), q(Vatican City State (Holy See)) ],
...
$Locale::Codes::Retired{'country'}{'numeric'}{'name'} = {
    ...
    q(south georgia and the south sandwich islands) =>
      [ q(239), q(South Georgia and the South Sandwich Islands) ],
    q(korea, democratic people's republic of) =>
      [ q(408), q(Korea, Democratic People's Republic of) ],
    ...
    q(congo, the democratic republic of the) =>
      [ q(180), q(Congo, The Democratic Republic of the) ],
    ...
    q(macedonia, the former yugoslav republic of) =>
      [ q(807), q(Macedonia, the Former Yugoslav Republic of) ],
    ...
    q(macao special administrative region of china) =>
      [ q(446), q(Macao Special Administrative Region of China) ],
    q(palestinian territory, occupied) =>
      [ q(275), q(Palestinian Territory, Occupied) ],
    ...
    q(tanzania, united republic of) =>
      [ q(834), q(Tanzania, United Republic of) ],
    q(bouvet island) => [ q(074), q(Bouvet Island) ],
    q(holy see (vatican city state)) =>
      [ q(336), q(Holy See (Vatican City State)) ],
    q(micronesia, federated states of) =>
      [ q(583), q(Micronesia, Federated States of) ],
...
$Locale::Codes::Retired{'country'}{'alpha-3'}{'name'} = {
    ...
    q(south georgia and the south sandwich islands) =>
      [ q(sgs), q(South Georgia and the South Sandwich Islands) ],
    q(korea, democratic people's republic of) =>
      [ q(prk), q(Korea, Democratic People's Republic of) ],
...
$Locale::Codes::Retired{'country'}{'fips-10'}{'name'} = {
    ...
    q(federal democratic republic of ethiopia) =>
      [ q(ET), q(Federal Democratic Republic of Ethiopia) ],
    ...
    q(territorial collectivity of mayotte) =>
      [ q(MF), q(Territorial Collectivity of Mayotte) ],
    ...
    q(hong kong special administrative region) =>
      [ q(HK), q(Hong Kong Special Administrative Region) ],
    ...
    q(commonwealth of the northern mariana islands) =>
      [ q(CQ), q(Commonwealth of the Northern Mariana Islands) ],
    ...
    q(islamic republic of mauritania) =>
      [ q(MR), q(Islamic Republic of Mauritania) ],
    ...
    q(bolivarian republic of venezuela) =>
      [ q(VE), q(Bolivarian Republic of Venezuela) ],
    ...
    q(socialist republic of vietnam) =>
      [ q(VM), q(Socialist Republic of Vietnam) ],
    q(federation of saint kitts and nevis) =>
      [ q(SC), q(Federation of Saint Kitts and Nevis) ],
    ...
    q(islamic republic of pakistan) =>
      [ q(PK), q(Islamic Republic of Pakistan) ],
    ...
    q(territory of ashmore and cartier islands) =>
      [ q(AT), q(Territory of Ashmore and Cartier Islands) ],
    ...
    q(great socialist people's libyan arab jamahiriya) =>
      [ q(LY), q(Great Socialist People's Libyan Arab Jamahiriya) ],
    ...
    q(territory of heard island and mcdonald islands) =>
      [ q(HM), q(Territory of Heard Island and McDonald Islands) ],
    ...
    q(oriental republic of uruguay) =>
      [ q(UY), q(Oriental Republic of Uruguay) ],
    ...
    q(territory of new caledonia and dependencies) =>
      [ q(NC), q(Territory of New Caledonia and Dependencies) ],
    ...
    q(territory of the french southern and antarctic lands) =>
      [ q(FS), q(Territory of the French Southern and Antarctic Lands) ],
    ...
    q(republic of the fiji islands) =>
      [ q(FJ), q(Republic of the Fiji Islands) ],
    ...
    q(republic of equatorial guinea) =>
      [ q(EK), q(Republic of Equatorial Guinea) ],
    q(macau special administrative region) =>
      [ q(MC), q(Macau Special Administrative Region) ],
    ...
    q(pitcairn, henderson, ducie and oeno islands) =>
      [ q(PC), q(Pitcairn, Henderson, Ducie and Oeno Islands) ],
    ...
    q(democratic socialist republic of sri lanka) =>
      [ q(CE), q(Democratic Socialist Republic of Sri Lanka) ],
    ...
    q(independent state of papua new guinea) =>
      [ q(PP), q(Independent State of Papua New Guinea) ],
    ...
    q(people's democratic republic of algeria) =>
      [ q(AG), q(People's Democratic Republic of Algeria) ],
    ...
    q(republic of the marshall islands) =>
      [ q(RM), q(Republic of the Marshall Islands) ],
    ...
    q(co-operative republic of guyana) =>
      [ q(GY), q(Co-operative Republic of Guyana) ],
    ...
    q(territory of french polynesia) =>
      [ q(FP), q(Territory of French Polynesia) ],
    ...
    q(territory of the wallis and futuna islands) =>
      [ q(WF), q(Territory of the Wallis and Futuna Islands) ],
    ...
    q(territory of christmas island) =>
      [ q(KT), q(Territory of Christmas Island) ],
    ...
    q(federal islamic republic of the comoros) =>
      [ q(CN), q(Federal Islamic Republic of the Comoros) ],
    q(republic of kenya) => [ q(KE), q(Republic of Kenya) ],
    q(principality of liechtenstein) =>
      [ q(LS), q(Principality of Liechtenstein) ],
};
