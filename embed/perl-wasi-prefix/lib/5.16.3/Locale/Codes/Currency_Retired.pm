...
$Locale::Codes::Retired{'currency'}{'alpha'}{'name'} = {
    ...
    q(netherlands antillian guilder) =>
      [ q(ANG), q(Netherlands Antillian Guilder) ],
    ...
    q(european unit of account 9(e.u.a.-9)) =>
      [ q(XBC), q(European Unit of Account 9(E.U.A.-9)) ],
    ...
    q(european monetary unit (e.m.u.-6)) =>
      [ q(XBB), q(European Monetary Unit (E.M.U.-6)) ],
    ...
    q(bermudian dollar (customarily known as bermuda dollar)) =>
      [ q(BMD), q(Bermudian Dollar (customarily known as Bermuda Dollar)) ],
