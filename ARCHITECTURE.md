...
| Asset | Binding | Role |
|---|---|---|
| embed/perl-wasi-prefix | go:embed all | Perl stdlib and wasm32-wasi modules |
...
The guest environment includes PERL5LIB=/lib/5.42.0:/lib/5.42.0/wasm32-wasi.
